...
full_node = Node(address=addr, rpc_port=8334, ws_port=18334, node_name='fullnode-jenkins-qc')
...
shard_list = [Shard([Node(address=addr, rpc_port=29339, ws_port=39339, node_name='shard0-0'),
              ...
              Shard([Node(address=addr, rpc_port=29345, ws_port=39345, node_name='shard1-0'),
                     ...
                     Node(address=addr, rpc_port=29349, ws_port=39349, node_name='shard1-4'),
                     Node(address=addr, rpc_port=29350, ws_port=39350, node_name='shard1-5'),
                     ])
              ]
