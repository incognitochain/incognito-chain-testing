...
from TestCases.ChainTestSanity import account_0, account_1, account_11, fixed_validators, auto_stake_list
...
def test_02_transaction():
    ...
    sender_bal_b4 = account_0.get_balance()
    receiver_bal_b4 = account_1.get_balance()
    tx_send_no_privacy = \
    ...
    sender_bal_b4 = account_1.get_balance()
    receiver0_bal_b4 = account_0.get_balance()
    receiver11_bal_b4 = account_11.get_balance()
    ...
    sender_bal_af = account_1.get_balance()
    receiver0_bal_af = account_0.get_balance()
    receiver11_bal_af = account_11.get_balance()
...
def test_04_staking(stake_funder, the_staked, auto_stake):
    ...
    bal_before_stake = stake_funder.get_balance()
    ...
    assert stake_funder.get_balance(cache=True) == stake_funder.get_balance() + stake_fee + coin(1750)
...
def test_05_init_token_privacy_n_bridge():
    ...
    bal_tok_af_init = COIN_MASTER.get_balance(P___TOKEN)
    bal_prv_af_init = COIN_MASTER.get_balance()
    ...
    bal_tok_b4_0 = account_0.get_balance(P___TOKEN)
    bal_tok_b4_1 = account_1.get_balance(P___TOKEN)
    ...
    assert bal_tok_af_init - sum(receivers.values()) == COIN_MASTER.get_balance(P___TOKEN)
    ...
    prv_bal_b4 = COIN_MASTER.get_balance()
    tok_bal_b4 = COIN_MASTER.get_balance(BRD_TOKEN)
    ...
    prv_bal_af = COIN_MASTER.get_balance()
    ...
    account_0.get_balance(BRD_TOKEN)
    account_1.get_balance(BRD_TOKEN)
    ...
    sender_tok_bal_af = COIN_MASTER.get_balance(BRD_TOKEN)
    sender_prv_bal_af = COIN_MASTER.get_balance()
    ...
    for account, amount in receivers.items():
        tok_bal_b4 = account.get_balance(BRD_TOKEN)
...
def test_06_dex_v1():
    ...
    bal_brd_b4 = account_0.get_balance(BRD_TOKEN)
    bal_p___b4 = account_0.get_balance(P___TOKEN)
...
def test_07_dex_v2():
    ...
    bal_prv_af = COIN_MASTER.get_balance()
    ...
    trade_tx = COIN_MASTER.pde_trade_v2(PRV_ID, PRV_TRADE_AMOUNT, P___TOKEN, trading_fee). \
        expect_no_error().subscribe_transaction()
    bal_prv_af_trade = COIN_MASTER.get_balance()
    ...
    bal_tok_b4_trade = COIN_MASTER.get_balance(custom_token_id)
    bal_brd_b4_trade = COIN_MASTER.get_balance(BRD_TOKEN)
    ...
    bal_tok_af_trade = COIN_MASTER.get_balance(custom_token_id)
...
def test_08_transaction_ptoken(token, privacy):
    ...
    send_amounts = {account_0: random.randrange(1000, 10000),
                    account_1: random.randrange(1000, 10000)}
    bal_receiver_b4 = {account_0: account_0.get_balance(token),
                       account_1: account_1.get_balance(token)}
    bal_sender_b4 = COIN_MASTER.get_balance(token)
    ...
    bal_sender_af = COIN_MASTER.get_balance(token)
...
def test_10_withdraw_reward(committee, reward_token):
    ...
    prv_bal_b4_withdraw_reward = committee.get_balance()
    ...
    token_bal_b4_withdraw_reward = committee.get_balance(reward_token)
