...
from Objects.AccountObject import PORTAL_FEEDER, COIN_MASTER, Account
from Objects.IncognitoTestCase import SUT
from Objects.PortalObjects import PortingReqInfo, PTokenReqInfo
from TestCases.ChainTestBusiness.Portal import portal_user, cli_pass_phrase, \
...
def test_create_porting_req_1_1(token, porting_amount, user: Account, porting_fee, num_of_custodian, desired_status):
    ...
    porting_id = porting_req.rpc_params().get_portal_register_id()
    porting_fee = porting_req.rpc_params().get_portal_porting_fee()
...
def prepare_fat_custodian():
    from TestCases.ChainTestBusiness.Portal import find_fat_custodian, big_collateral, fat_custodian_prv
