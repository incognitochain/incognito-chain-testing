...
from TestCases.ChainTestBusiness.DEX import token_id_1, token_owner, token_id_2
...
def test_contribute(token1, token2):
    ...
    bal_tok1_aft_contrib = token_owner.get_balance(token1)
    bal_tok2_aft_contrib = token_owner.get_balance(token2)
