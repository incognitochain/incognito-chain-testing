...
type MnBurningForDepositToSCRes struct {
	rpccaller.RPCBaseRes
	Result interface{} `json:"Result"`
}

type MnBalanceIncAccount struct {
	Result interface{} `json:"Result"`
}

type MnTxhashInC struct {
	Result interface{} `json:"Result"`
}
...
// before each test
func (tradingSuite *MnTradingTestSuite) SetupSuite() {
...
func (tradingSuite *MnTradingTestSuite) TearDownSuite() {
	fmt.Println("Tearing down the suite...")
	tradingSuite.ETHClient.Close()
}

func (tradingSuite *MnTradingTestSuite) SetupTest() {
	fmt.Println("Setting up the test...")
}

func (tradingSuite *MnTradingTestSuite) TearDownTest() {
	fmt.Println("Tearing down the test...")
}

func TestMnTradingTestSuite(t *testing.T) {
	fmt.Println("Starting entry point for test suite...")

	tradingSuite := new(MnTradingTestSuite)
	suite.Run(t, tradingSuite)

	fmt.Println("Finishing entry point for test suite...")
}
func (tradingSuite *MnTradingTestSuite) getBalanceOnETHNet(
...
func (tradingSuite *MnTradingTestSuite) connectToETH() {
...
func (tradingSuite *MnTradingTestSuite) depositETH(
	amt float64,
	incPaymentAddrStr string,
) common.Hash {
...
func (tradingSuite *MnTradingTestSuite) depositERC20ToBridge(
	amt *big.Int,
	tokenAddr common.Address,
	incPaymentAddrStr string,
) common.Hash {
...
func (tradingSuite *MnTradingTestSuite) callIssuingETHReq(
...
func (tradingSuite *MnTradingTestSuite) callBurningPToken(
	incTokenIDStr string,
	amount *big.Int,
...
func (tradingSuite *MnTradingTestSuite) submitBurnProofForDepositToSC(
...
func (tradingSuite *MnTradingTestSuite) submitBurnProofForWithdrawal(
	burningTxIDStr string,
) common.Hash {
...
func (tradingSuite *MnTradingTestSuite) genKeysPairForSC() {
...
func (tradingSuite *MnTradingTestSuite) getDepositedBalance(
...
func (tradingSuite *MnTradingTestSuite) getBalancePrvIncAccount(
	IncPrivKeyStr string,
) (uint64, error) {
	rpcClient := rpccaller.NewRPCClient()
	params := []interface{}{
...
func (tradingSuite *MnTradingTestSuite) getFeePRVbyTxhashInC(
	txhash string,
) uint64 {
	rpcClient := rpccaller.NewRPCClient()
	params := []interface{}{
...
func (tradingSuite *MnTradingTestSuite) getGasFeeETHbyTxhash(txHash common.Hash) *big.Int {
...
func (tradingSuite *MnTradingTestSuite) getStatusTxhash(txHash common.Hash) uint64 {
...
func (tradingSuite *MnTradingTestSuite) getExpectedAmount(
	srcToken string,
	destToken string,
	srcQty *big.Int,
) *big.Int {
...
func (tradingSuite *MnTradingTestSuite) executeWithUniswap(
	srcQty *big.Int,
...
func (tradingSuite *MnTradingTestSuite) getExpectedRate(
	srcToken string,
	destToken string,
	srcQty *big.Int,
) *big.Int {
...
func (tradingSuite *MnTradingTestSuite) executeWithKyber(
	srcQty *big.Int,
	srcTokenIDStr string,
	destTokenIDStr string,
) {
