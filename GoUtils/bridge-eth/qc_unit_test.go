...
func (tradingSuite *UniTradingTestSuite) SetupSuite() {
	...
	tradingSuite.IncUSDCTokenIDStr = "61e1efbf6be9decc46fdf8250cdae5be12bee501b65f774a58af4513b645f6a3" // testnet
	...
	tradingSuite.USDCAddressStr = "0x75b0622cec14130172eae9cf166b92e5c112faff"  // tesnet
...
return
	...
	balWBTCwithdraw := big.NewInt(0).Sub(balWBTCScTradeS31, balWBTCScTradeS3)
...
func (tradingSuite *UniTradingTestSuite) Testt4DepositAndWithdrwaERC20tokenUSDC() {
return
