...
func (tradingSuite *UniswapTradingTestSuite) SetupSuite() {
	...
	// Kovan env
	tradingSuite.IncMRKTokenIDStr = "497159cf6c9f8d5a7cffd38d392649fee7b61558689ba631b26ef1b2dd8c9a06"
	tradingSuite.MRKAddressStr = "0x575537A9e553aD212ea46A20529fBe4326719a92"                                 // kovan
	tradingSuite.WETHAddr = "0xd0a1e359811322d97991e03f863a0c30c2cf029c"                                      // kovan
	tradingSuite.UniswapTradeDeployedAddr = common.HexToAddress("0xfAAa26e153dE1d800F8d67FdE3C4391A435c1fEe") //kovan
...
return
	...
	depositingDAI := big.NewInt(int64(tradingSuite.DepositingEther * params.Ether))
	tradeAmount := big.NewInt(int64(tradingSuite.DepositingEther * params.Ether))
	burningPDAI := big.NewInt(0).Div(tradeAmount, big.NewInt(1000000000))
