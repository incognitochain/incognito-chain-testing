...
class ws():
    ...
    def subcribeNewShardBlock(self):
        data = {"request":{"jsonrpc": "1.0","method": "subcribenewshardblock","params": [0],"id": 1},"subcription": "11","type": 0,}
    ...
    def subcribePendingTransaction(self, txid):
        data = {"request":{"jsonrpc": "1.0","method": "subcribependingtransaction","params": [txid],"id": 1},"subcription": "11","type": 0,}
        self.ws_conn.send(json.dumps(data))
    ...
    def subcribeCrossOutputCoinByPrivatekey(self, privatekey):
        data = {"request":{"jsonrpc": "1.0","method": "subcribecrossoutputcoinbyprivatekey","params": [privatekey],"id": 1},"subcription": "11","type": 0,}
        self.ws_conn.send(json.dumps(data))
