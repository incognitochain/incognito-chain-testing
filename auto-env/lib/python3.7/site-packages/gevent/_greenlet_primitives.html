...
<div class="cython">
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">01</span>: <span class="c"># -*- coding: utf-8 -*-</span></pre>
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">02</span>: <span class="c"># copyright (c) 2018 gevent. See  LICENSE.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">03</span>: <span class="c"># cython: auto_pickle=False,embedsignature=True,always_allow_keywords=False</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">04</span>: <span class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">05</span>: <span class="sd">A collection of primitives used by the hub, and suitable for</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">06</span>: <span class="sd">compilation with Cython because of their frequency of use.</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">09</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
            class="k">import</span> <span class="n">absolute_import</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">10</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
            class="k">import</span> <span class="n">division</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">11</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">13</span>: <span class="k">from</span> <span class="nn">weakref</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">14</span>: <span class="k">from</span> <span class="nn">gc</span> <span
            class="k">import</span> <span class="n">get_objects</span></pre>
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_ImportFrom</span>(__pyx_t_1, __pyx_n_s_get_objects);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-11"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">16</span>: <span class="k">from</span> <span class="nn">greenlet</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">18</span>: <span class="k">from</span> <span class="nn">gevent.exceptions</span> <span class="k">import</span> <span
            class="n">BlockingSwitchOutError</span></pre>
    <pre class='cython code score-16 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_ImportFrom</span>(__pyx_t_1, __pyx_n_s_BlockingSwitchOutError);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_2);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">21</span>: <span class="c"># In Cython, we define these as &#39;cdef inline&#39; functions. The</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">22</span>: <span class="c"># compilation unit cannot have a direct assignment to them (import</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">23</span>: <span class="c"># is assignment) without generating a &#39;lvalue is not valid target&#39;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">24</span>: <span class="c"># error.</span></pre>
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">25</span>: <span class="nb">locals</span><span class="p">()[</span><span class="s">&#39;getcurrent&#39;</span><span
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple_);
    ...
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">26</span>: <span class="nb">locals</span><span class="p">()[</span><span class="s">&#39;greenlet_init&#39;</span><span
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_21__greenlet_primitives_4lambda, 0, __pyx_n_s_lambda, NULL, __pyx_n_s_gevent___greenlet_primitives, __pyx_d, NULL);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-11"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">27</span>: <span class="nb">locals</span><span class="p">()[</span><span class="s">&#39;_greenlet_switch&#39;</span><span
            class="p">]</span> <span class="o">=</span> <span class="n">greenlet</span><span class="o">.</span><span
            class="n">switch</span></pre>
    <pre class='cython code score-11 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_21__greenlet_primitives_greenlet), __pyx_n_s_switch);<span
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  if (unlikely(<span
                class='py_c_api'>PyDict_SetItem</span>(__pyx_t_1, __pyx_n_s_greenlet_switch, __pyx_t_2) &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 27, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
</pre>
    ...
    <pre class="cython line score-15"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">29</span>: <span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span></pre>
    <pre class='cython code score-15 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(2);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">30</span>:     <span
            class="s">&#39;TrackedRawGreenlet&#39;</span><span class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">31</span>:     <span class="s">&#39;SwitchOutGreenletWithLoop&#39;</span><span
            class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">32</span>: <span class="p">]</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">33</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">34</span>: <span class="k">class</span> <span class="nc">TrackedRawGreenlet</span><span
    ...
    <pre class="cython line score-31"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">36</span>:     <span class="k">def</span> <span class="nf">__init__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">function</span><span
            class="p">,</span> <span class="n">parent</span><span class="p">):</span></pre>
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__init__") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 36, __pyx_L3_error)</span>
      }
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-42"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">37</span>:         <span class="n">greenlet</span><span class="o">.</span><span
            class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span
            class="n">function</span><span class="p">,</span> <span class="n">parent</span><span
            class="p">)</span></pre>
    <pre class='cython code score-42 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_21__greenlet_primitives_greenlet), __pyx_n_s_init);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">38</span>:         <span class="c"># See greenlet.py&#39;s Greenlet class. We capture the cheap</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">39</span>:         <span class="c"># parts to maintain the tree structure, but we do not capture</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">40</span>:         <span class="c"># the stack because that&#39;s too expensive for &#39;spawn_raw&#39;.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">41</span>: </pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">42</span>:         <span class="n">current</span> <span class="o">=</span> <span class="n">getcurrent</span><span
            class="p">()</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-0 '>  __pyx_t_1 = ((PyObject *)__pyx_f_6gevent_21__greenlet_primitives_getcurrent());<span
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">43</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">spawning_greenlet</span> <span
            class="o">=</span> <span class="n">wref</span><span class="p">(</span><span class="n">current</span><span
            class="p">)</span></pre>
  ...
  __pyx_t_1 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_5, ((PyObject *)__pyx_v_current)) : <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_2, ((PyObject *)__pyx_v_current));
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_5); __pyx_t_5 = 0;
  if (unlikely(!__pyx_t_1)) <span class='error_goto'>__PYX_ERR(0, 43, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  if (<span class='pyx_c_api'>__Pyx_PyObject_SetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_spawning_greenlet, __pyx_t_1) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 43, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">44</span>:         <span class="c"># See Greenlet for how trees are maintained.</span></pre>
    <pre class="cython line score-11"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">45</span>:         <span class="k">try</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">46</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">spawn_tree_locals</span> <span
            class="o">=</span> <span class="n">current</span><span class="o">.</span><span
            class="n">spawn_tree_locals</span></pre>
    <pre class='cython code score-5 '>      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_current), __pyx_n_s_spawn_tree_locals);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L3_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
      if (<span class='pyx_c_api'>__Pyx_PyObject_SetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_spawn_tree_locals, __pyx_t_1) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 46, __pyx_L3_error)</span>
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
</pre>
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">47</span>:         <span class="k">except</span> <span class="ne">AttributeError</span><span
            class="p">:</span></pre>
    ...
    if (__pyx_t_4) {
      <span class='pyx_c_api'>__Pyx_AddTraceback</span>("gevent.__greenlet_primitives.TrackedRawGreenlet.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (<span class='pyx_c_api'>__Pyx_GetException</span>(&amp;__pyx_t_1, &amp;__pyx_t_2, &amp;__pyx_t_5) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 47, __pyx_L5_except_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
</pre>
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">48</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">spawn_tree_locals</span> <span
            class="o">=</span> <span class="p">{}</span></pre>
    <pre class='cython code score-5 '>      __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(0);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 48, __pyx_L5_except_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
      if (<span class='pyx_c_api'>__Pyx_PyObject_SetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_spawn_tree_locals, __pyx_t_3) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 48, __pyx_L5_except_error)</span>
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre>
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">49</span>:             <span class="k">if</span> <span class="n">current</span><span
            class="o">.</span><span class="n">parent</span><span class="p">:</span></pre>
    <pre class='cython code score-8 '>      __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_current), __pyx_n_s_parent);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L5_except_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
      __pyx_t_9 = <span class='pyx_c_api'>__Pyx_PyObject_IsTrue</span>(__pyx_t_3); if (unlikely(__pyx_t_9 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 49, __pyx_L5_except_error)</span>
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_9) {
/* … */
      }
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">50</span>:                 <span class="n">current</span><span class="o">.</span><span class="n">spawn_tree_locals</span> <span
            class="o">=</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">spawn_tree_locals</span></pre>
    <pre class='cython code score-5 '>        __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_spawn_tree_locals);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 50, __pyx_L5_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
        if (<span class='pyx_c_api'>__Pyx_PyObject_SetAttrStr</span>(((PyObject *)__pyx_v_current), __pyx_n_s_spawn_tree_locals, __pyx_t_3) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 50, __pyx_L5_except_error)</span>
        <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">53</span>: <span class="k">class</span> <span class="nc">SwitchOutGreenletWithLoop</span><span
            class="p">(</span><span class="n">TrackedRawGreenlet</span><span class="p">):</span></pre>
...
static struct __pyx_vtabstruct_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *__pyx_vtabptr_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">54</span>:     <span
            class="c"># Subclasses must define:</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">55</span>:     <span class="c"># - self.loop</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">56</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">57</span>:     <span class="c"># This class defines loop in its .pxd for Cython. This lets us avoid</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">58</span>:     <span class="c"># circular dependencies with the hub.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">59</span>: </pre>
    <pre class="cython line score-63"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">60</span>:     <span class="k">def</span> <span class="nf">switch</span><span
...
static PyObject *__pyx_f_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_switch(struct __pyx_obj_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_switch);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
...
static PyObject *__pyx_pf_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_switch(struct __pyx_obj_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *__pyx_v_self) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("switch", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_switch(__pyx_v_self, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_1switch, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_SwitchOutGreenletWithLoop_switch, NULL, __pyx_n_s_gevent___greenlet_primitives, __pyx_d, ((PyObject *)__pyx_codeobj__3));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop-&gt;tp_dict, __pyx_n_s_switch, __pyx_t_2) &lt; 0) <span
  ...
  __pyx_codeobj__3 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__2, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__greenlet_primitives, __pyx_n_s_switch, 60, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__3)) __PYX_ERR(0, 60, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">61</span>:         <span class="n">switch_out</span> <span class="o">=</span> <span class="nb">getattr</span><span
            class="p">(</span><span class="n">getcurrent</span><span class="p">(),</span> <span class="s">&#39;switch_out&#39;</span><span
            class="p">,</span> <span class="bp">None</span><span class="p">)</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = ((PyObject *)__pyx_f_6gevent_21__greenlet_primitives_getcurrent());<span
  ...
  __pyx_t_2 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">62</span>:         <span class="k">if</span> <span class="n">switch_out</span> <span
...
/* … */
    ...
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">63</span>:             <span class="n">switch_out</span><span class="p">()</span></pre>
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">64</span>:         <span class="k">return</span> <span class="n">_greenlet_switch</span><span
            class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-1 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_2 = __pyx_f_6gevent_21__greenlet_primitives__greenlet_switch(((PyGreenlet *)__pyx_v_self));<span
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-62"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">66</span>:     <span class="k">def</span> <span class="nf">switch_out</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_switch_out(CYTHON_UNUSED struct __pyx_obj_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      PY_UINT64_T type_dict_guard = (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict)) ? __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) : 0;
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_switch_out);<span
...
static PyObject *__pyx_pf_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_2switch_out(struct __pyx_obj_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *__pyx_v_self) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("switch_out", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_switch_out(__pyx_v_self, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_21__greenlet_primitives_25SwitchOutGreenletWithLoop_3switch_out, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_SwitchOutGreenletWithLoop_switch_2, NULL, __pyx_n_s_gevent___greenlet_primitives, __pyx_d, ((PyObject *)__pyx_codeobj__5));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 66, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop-&gt;tp_dict, __pyx_n_s_switch_out, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 66, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop);
  __pyx_codeobj__5 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__4, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__greenlet_primitives, __pyx_n_s_switch_out, 66, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__5)) __PYX_ERR(0, 66, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">67</span>:         <span class="k">raise</span> <span class="n">BlockingSwitchOutError</span><span
            class="p">(</span><span
            class="s">&#39;Impossible to call blocking function in the event loop callback&#39;</span><span
            class="p">)</span></pre>
  ...
  __pyx_t_1 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_3, __pyx_kp_s_Impossible_to_call_blocking_func) : <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_2, __pyx_kp_s_Impossible_to_call_blocking_func);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  ...
  <span class='error_goto'>__PYX_ERR(0, 67, __pyx_L1_error)</span>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">68</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">69</span>: </pre>
    <pre class="cython line score-21"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">70</span>: <span class="k">def</span> <span class="nf">get_reachable_greenlets</span><span
            class="p">():</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_21__greenlet_primitives_1get_reachable_greenlets, 0, __pyx_n_s_get_reachable_greenlets, NULL, __pyx_n_s_gevent___greenlet_primitives, __pyx_d, ((PyObject *)__pyx_codeobj__6));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 70, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_d, __pyx_n_s_get_reachable_greenlets, __pyx_t_2) &lt; 0) <span
...
/* … */
  __pyx_codeobj__6 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__greenlet_primitives, __pyx_n_s_get_reachable_greenlets, 70, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__6)) __PYX_ERR(0, 70, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">71</span>:     <span class="c"># We compile this loop with Cython so that it&#39;s faster, and so that</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">72</span>:     <span class="c"># the GIL isn&#39;t dropped at unpredictable times during the loop.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">73</span>:     <span class="c"># Dropping the GIL could lead to accessing partly constructed objects</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">74</span>:     <span class="c"># in undefined states (particularly, tuples). This helps close a hole</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">75</span>:     <span class="c"># where a `SystemError: Objects/tupleobject.c bad argument to internal function`</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">76</span>:     <span class="c"># could get raised. (Note that this probably doesn&#39;t completely close the hole,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">77</span>:     <span class="c"># if other threads have dropped the GIL, but hopefully the speed makes that</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">78</span>:     <span class="c"># more rare.) See https://github.com/gevent/gevent/issues/1302</span></pre>
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">79</span>:     <span class="k">return</span> <span class="p">[</span></pre>
  ...
  { /* enter inner scope */
    ...
    <pre class="cython line score-65"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">80</span>:         <span class="n">x</span> <span class="k">for</span> <span
            class="n">x</span> <span class="ow">in</span> <span class="n">get_objects</span><span
            class="p">()</span></pre>
    ...
    for (;;) {
      if (likely(!__pyx_t_6)) {
        if (likely(<span class='py_c_api'>PyList_CheckExact</span>(__pyx_t_3))) {
          ...
          __pyx_t_2 = <span class='py_macro_api'>PyList_GET_ITEM</span>(__pyx_t_3, __pyx_t_5); <span
                class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_2); __pyx_t_5++; if (unlikely(0 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 80, __pyx_L5_error)</span>
          #else
          __pyx_t_2 = <span class='py_macro_api'>PySequence_ITEM</span>(__pyx_t_3, __pyx_t_5); __pyx_t_5++;<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 80, __pyx_L5_error)</span>
          <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
          #endif
        } else {
          if (__pyx_t_5 &gt;= <span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_t_3)) break;
          #if CYTHON_ASSUME_SAFE_MACROS &amp;&amp; !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_2 = <span class='py_macro_api'>PyTuple_GET_ITEM</span>(__pyx_t_3, __pyx_t_5); <span
                class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_2); __pyx_t_5++; if (unlikely(0 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 80, __pyx_L5_error)</span>
          #else
          __pyx_t_2 = <span class='py_macro_api'>PySequence_ITEM</span>(__pyx_t_3, __pyx_t_5); __pyx_t_5++;<span
      ...
      __pyx_t_2 = 0;
/* … */
        if (unlikely(<span class='pyx_c_api'>__Pyx_ListComp_Append</span>(__pyx_t_1, (PyObject*)__pyx_7genexpr__pyx_v_x))) <span
                class='error_goto'>__PYX_ERR(0, 79, __pyx_L5_error)</span>
/* … */
    }
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">81</span>:         <span class="k">if</span> <span class="nb">isinstance</span><span
            class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">greenlet</span><span
            class="p">)</span> <span class="ow">and</span> <span class="ow">not</span> <span
            class="nb">getattr</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span
            class="s">&#39;greenlet_tree_is_ignored&#39;</span><span class="p">,</span> <span
    ...
    <pre class='cython code score-5 '>      __pyx_t_8 = <span class='pyx_c_api'>__Pyx_TypeCheck</span>(__pyx_7genexpr__pyx_v_x, __pyx_ptype_6gevent_21__greenlet_primitives_greenlet);
      ...
      __pyx_t_2 = __Pyx_GetAttr3(__pyx_7genexpr__pyx_v_x, __pyx_n_s_greenlet_tree_is_ignored, Py_False);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L5_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      __pyx_t_9 = <span class='pyx_c_api'>__Pyx_PyObject_IsTrue</span>(__pyx_t_2); if (unlikely(__pyx_t_9 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 81, __pyx_L5_error)</span>
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">82</span>:     <span class="p">]</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">83</span>: </pre>
    <pre class="cython line score-9"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">84</span>: <span class="k">def</span> <span class="nf">_init</span><span class="p">():</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_21__greenlet_primitives_3_init, 0, __pyx_n_s_init_2, NULL, __pyx_n_s_gevent___greenlet_primitives, __pyx_d, ((PyObject *)__pyx_codeobj__7));<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">85</span>:     <span class="n">greenlet_init</span><span class="p">()</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-0 '>  __pyx_f_6gevent_21__greenlet_primitives_greenlet_init();
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">86</span>: </pre>
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">87</span>: <span class="n">_init</span><span class="p">()</span></pre>
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">88</span>: </pre>
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">89</span>: <span class="k">from</span> <span class="nn">gevent._util</span> <span
    ...
    <pre class='cython code score-19 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">90</span>: <span class="n">import_c_accel</span><span class="p">(</span><span
            class="nb">globals</span><span class="p">(),</span> <span
            class="s">&#39;gevent.__greenlet_primitives&#39;</span><span class="p">)</span></pre>
