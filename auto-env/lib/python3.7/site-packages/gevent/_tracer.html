...
<div class="cython">
    <pre class="cython line score-0">&#xA0;<span class="">001</span>: <span class="c"># Copyright (c) 2018 gevent. See LICENSE for details.</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">003</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
            class="k">import</span> <span class="n">print_function</span><span class="p">,</span> <span class="n">absolute_import</span><span
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">005</span>: <span class="k">import</span> <span class="nn">sys</span></pre>
    <pre class='cython code score-3 '>  __pyx_t_1 = <span
            class='pyx_c_api'>__Pyx_Import</span>(__pyx_n_s_sys, 0, 0);<span class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)</span>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">006</span>: <span class="k">import</span> <span class="nn">traceback</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">008</span>: <span class="k">from</span> <span class="nn">greenlet</span> <span
            class="k">import</span> <span class="n">settrace</span></pre>
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">009</span>: <span class="k">from</span> <span class="nn">greenlet</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">011</span>: <span class="k">from</span> <span class="nn">gevent.util</span> <span
            class="k">import</span> <span class="n">format_run_info</span></pre>
    <pre class='cython code score-16 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_ImportFrom</span>(__pyx_t_2, __pyx_n_s_format_run_info);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_1);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">013</span>: <span class="k">from</span> <span class="nn">gevent._compat</span> <span class="k">import</span> <span
            class="n">perf_counter</span></pre>
    <pre class='cython code score-16 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_ImportFrom</span>(__pyx_t_1, __pyx_n_s_perf_counter);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_2);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">014</span>: <span class="k">from</span> <span class="nn">gevent._util</span> <span
            class="k">import</span> <span class="n">gmctime</span></pre>
    <pre class='cython code score-16 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class='cython code score-17 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(3);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">018</span>:     <span
            class="s">&#39;GreenletTracer&#39;</span><span class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">019</span>:     <span
            class="s">&#39;HubSwitchTracer&#39;</span><span class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">020</span>:     <span
            class="s">&#39;MaxSwitchTracer&#39;</span><span class="p">,</span></pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">027</span>: <span class="k">class</span> <span class="nc">GreenletTracer</span><span
...
static struct __pyx_vtabstruct_6gevent_8__tracer_GreenletTracer *__pyx_vtabptr_6gevent_8__tracer_GreenletTracer;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">028</span>:     <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">029</span>:         <span class="c"># A counter, incremented by the greenlet trace function</span></pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">033</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">greenlet_switch_counter</span> <span
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">036</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span> <span
  ...
  __pyx_v_self-&gt;active_greenlet = Py_None;
    ...
    <pre class="cython line score-15"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">043</span>:         <span class="n">prev_trace</span> <span class="o">=</span> <span class="n">settrace</span><span
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">045</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">previous_trace_function</span> <span
            class="o">=</span> <span class="n">prev_trace</span></pre>
  ...
  __pyx_v_self-&gt;previous_trace_function = __pyx_v_prev_trace;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">047</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_killed</span> <span class="o">=</span> <span class="bp">False</span></pre>
    ...
    <pre class="cython line score-63"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">049</span>:     <span class="k">def</span> <span class="nf">kill</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_8__tracer_14GreenletTracer_kill(struct __pyx_obj_6gevent_8__tracer_GreenletTracer *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      #endif
      __pyx_t_1 = <span
                class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_kill);<span
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_3kill, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer_kill, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__4));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 49, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_kill, __pyx_t_2) &lt; 0) <span
  ...
  __pyx_codeobj__4 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_kill, 49, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 49, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">050</span>:         <span class="c"># Must be called in the monitored thread.</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">051</span>:         <span class="k">if</span> <span class="ow">not</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">_killed</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">052</span>:             <span class="bp">self</span><span class="o">.</span><span
            class="n">_killed</span> <span class="o">=</span> <span class="bp">True</span></pre>
    <pre class='cython code score-0 '>    __pyx_v_self-&gt;_killed = 1;
</pre>
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">053</span>:             <span class="n">settrace</span><span class="p">(</span><span class="bp">self</span><span
            class="o">.</span><span class="n">previous_trace_function</span><span class="p">)</span></pre>
    ...
    __pyx_t_1 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_3, __pyx_v_self-&gt;previous_trace_function) : <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_2, __pyx_v_self-&gt;previous_trace_function);
    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">054</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">previous_trace_function</span> <span
            class="o">=</span> <span class="bp">None</span></pre>
    <pre class='cython code score-2 '>    <span class='pyx_macro_api'>__Pyx_INCREF</span>(Py_None);
    <span class='refnanny'>__Pyx_GIVEREF</span>(Py_None);
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;previous_trace_function);
    ...
    <pre class="cython line score-114"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">056</span>:     <span class="k">def</span> <span class="nf">_trace</span><span
...
static PyObject *__pyx_f_6gevent_8__tracer_14GreenletTracer__trace(struct __pyx_obj_6gevent_8__tracer_GreenletTracer *__pyx_v_self, PyObject *__pyx_v_event, PyObject *__pyx_v_args, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      PY_UINT64_T type_dict_guard = (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict)) ? __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) : 0;
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_trace);<span
...
static PyObject *__pyx_pw_6gevent_8__tracer_14GreenletTracer_5_trace(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_trace") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 56, __pyx_L3_error)</span>
      }
  ...
  <span class='pyx_c_api'>__Pyx_RaiseArgtupleInvalid</span>("_trace", 1, 2, 2, <span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args)); <span
                class='error_goto'>__PYX_ERR(0, 56, __pyx_L3_error)</span>
  __pyx_L3_error:;
  <span class='pyx_c_api'>__Pyx_AddTraceback</span>("gevent.__tracer.GreenletTracer._trace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  <span class='refnanny'>__Pyx_RefNannyFinishContext</span>();
  ...
  if (unlikely(!<span class='pyx_c_api'>__Pyx_ArgTypeTest</span>(((PyObject *)__pyx_v_event), (&amp;PyString_Type), 1, "event", 1))) <span
                class='error_goto'>__PYX_ERR(0, 56, __pyx_L1_error)</span>
  if (unlikely(!<span class='pyx_c_api'>__Pyx_ArgTypeTest</span>(((PyObject *)__pyx_v_args), (&amp;PyTuple_Type), 1, "args", 1))) <span
                class='error_goto'>__PYX_ERR(0, 56, __pyx_L1_error)</span>
...
static PyObject *__pyx_pf_6gevent_8__tracer_14GreenletTracer_4_trace(struct __pyx_obj_6gevent_8__tracer_GreenletTracer *__pyx_v_self, PyObject *__pyx_v_event, PyObject *__pyx_v_args) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_14GreenletTracer__trace(__pyx_v_self, __pyx_v_event, __pyx_v_args, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__5 = <span class='py_c_api'>PyTuple_Pack</span>(3, __pyx_n_s_self, __pyx_n_s_event, __pyx_n_s_args);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 56, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__5);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__5);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_5_trace, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer__trace, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__6));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_trace, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 56, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_GreenletTracer);
  __pyx_codeobj__6 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(3, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__5, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_trace, 56, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__6)) __PYX_ERR(0, 56, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">057</span>:         <span class="c"># This function runs in the thread we are monitoring.</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">058</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">greenlet_switch_counter</span> <span
    ...
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">059</span>:         <span class="k">if</span> <span class="n">event</span> <span
            class="ow">in</span> <span class="p">(</span><span class="s">&#39;switch&#39;</span><span class="p">,</span> <span
            class="s">&#39;throw&#39;</span><span class="p">):</span></pre>
    <pre class='cython code score-6 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_event);
  __pyx_t_7 = __pyx_v_event;
  __pyx_t_9 = (<span class='pyx_c_api'>__Pyx_PyString_Equals</span>(__pyx_t_7, __pyx_n_s_switch, Py_EQ)); if (unlikely(__pyx_t_9 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 59, __pyx_L1_error)</span>
  ...
  __pyx_t_10 = (<span class='pyx_c_api'>__Pyx_PyString_Equals</span>(__pyx_t_7, __pyx_n_s_throw, Py_EQ)); if (unlikely(__pyx_t_10 &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 59, __pyx_L1_error)</span>
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">060</span>:             <span class="c"># args is (origin, target). This is the only defined</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">061</span>:             <span class="c"># case</span></pre>
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">062</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span> <span
            class="o">=</span> <span class="n">args</span><span class="p">[</span><span class="mf">1</span><span
            class="p">]</span></pre>
    ...
    __pyx_t_1 = <span class='pyx_c_api'>__Pyx_GetItemInt_Tuple</span>(__pyx_v_args, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1);<span
    ...
    <pre class="cython line score-0">&#xA0;<span class="">063</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">064</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span> <span
            class="o">=</span> <span class="bp">None</span></pre>
  ...
  __pyx_L3:;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">065</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">previous_trace_function</span> <span class="ow">is</span> <span
...
/* … */
    ...
    <pre class="cython line score-39"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">066</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">previous_trace_function</span><span
            class="p">(</span><span class="n">event</span><span class="p">,</span> <span class="n">args</span><span
            class="p">)</span></pre>
    ...
    <pre class="cython line score-27"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">068</span>:     <span class="k">def</span> <span class="nf">__call__</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">event</span><span class="p">,</span> <span
...
static PyObject *__pyx_pw_6gevent_8__tracer_14GreenletTracer_7__call__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  <span class='pyx_c_api'>__Pyx_RaiseArgtupleInvalid</span>("__call__", 1, 2, 2, <span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args)); <span
                class='error_goto'>__PYX_ERR(0, 68, __pyx_L3_error)</span>
  __pyx_L3_error:;
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-21"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">069</span>:         <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_trace</span><span class="p">(</span><span class="n">event</span><span
            class="p">,</span> <span class="n">args</span><span class="p">)</span></pre>
    <pre class='cython code score-21 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  if (!(likely(<span class='py_c_api'>PyString_CheckExact</span>(__pyx_v_event))||((__pyx_v_event) == Py_None)||(<span
                class='py_c_api'>PyErr_Format</span>(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_v_event)-&gt;tp_name), 0))) <span
                class='error_goto'>__PYX_ERR(0, 69, __pyx_L1_error)</span>
  if (!(likely(<span class='py_c_api'>PyTuple_CheckExact</span>(__pyx_v_args))||((__pyx_v_args) == Py_None)||(<span
                class='py_c_api'>PyErr_Format</span>(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_v_args)-&gt;tp_name), 0))) <span
                class='error_goto'>__PYX_ERR(0, 69, __pyx_L1_error)</span>
  __pyx_t_1 = ((struct __pyx_vtabstruct_6gevent_8__tracer_GreenletTracer *)__pyx_v_self-&gt;__pyx_vtab)-&gt;_trace(__pyx_v_self, ((PyObject*)__pyx_v_event), ((PyObject*)__pyx_v_args), 0);<span
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-61"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">071</span>:     <span class="k">def</span> <span class="nf">did_block_hub</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_8__tracer_14GreenletTracer_did_block_hub(struct __pyx_obj_6gevent_8__tracer_GreenletTracer *__pyx_v_self, PyObject *__pyx_v_hub, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      PY_UINT64_T type_dict_guard = (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict)) ? __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) : 0;
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_did_block_hub);<span
...
static PyObject *__pyx_pf_6gevent_8__tracer_14GreenletTracer_8did_block_hub(struct __pyx_obj_6gevent_8__tracer_GreenletTracer *__pyx_v_self, PyObject *__pyx_v_hub) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("did_block_hub", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_14GreenletTracer_did_block_hub(__pyx_v_self, __pyx_v_hub, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__7 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_hub);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 71, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__7);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__7);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_9did_block_hub, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer_did_block_hub, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__8));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_did_block_hub, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 71, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_GreenletTracer);
  __pyx_codeobj__8 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_did_block_hub, 71, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 71, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">072</span>:         <span class="c"># Check to see if we have blocked since the last call to this</span></pre>
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">082</span>:         <span class="n">active_greenlet</span> <span class="o">=</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">083</span>:         <span class="n">did_switch</span> <span class="o">=</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">greenlet_switch_counter</span> <span class="o">!=</span> <span class="mf">0</span></pre>
    <pre class='cython code score-0 '>  __pyx_v_did_switch = (__pyx_v_self-&gt;greenlet_switch_counter != 0);
</pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">084</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">greenlet_switch_counter</span> <span
            class="o">=</span> <span class="mf">0</span></pre>
    <pre class='cython code score-0 '>  __pyx_v_self-&gt;greenlet_switch_counter = 0;
</pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">086</span>:         <span class="k">if</span> <span class="n">did_switch</span> <span
            class="ow">or</span> <span class="n">active_greenlet</span> <span class="ow">is</span> <span
            class="bp">None</span> <span class="ow">or</span> <span class="n">active_greenlet</span> <span
            class="ow">is</span> <span class="n">hub</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">087</span>:             <span class="c"># Either we switched, or nothing is running (we got a</span></pre>
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">091</span>:             <span class="k">return</span> <span class="bp">False</span></pre>
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">092</span>:         <span class="k">return</span> <span class="bp">True</span><span
            class="p">,</span> <span class="n">active_greenlet</span></pre>
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-21"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">094</span>:     <span class="k">def</span> <span class="nf">ignore_current_greenlet_blocking</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_11ignore_current_greenlet_blocking, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer_ignore_current_gr, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__10));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 94, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_ignore_current_greenlet_blocking, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 94, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_GreenletTracer);
  __pyx_codeobj__10 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_ignore_current_greenlet_blocking, 94, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 94, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">095</span>:         <span class="c"># Don&#39;t pay attention to the current greenlet.</span></pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">096</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span> <span
            class="o">=</span> <span class="bp">None</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GIVEREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;active_greenlet);
  ...
  __pyx_v_self-&gt;active_greenlet = Py_None;
    ...
    <pre class="cython line score-26"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">098</span>:     <span class="k">def</span> <span
            class="nf">monitor_current_greenlet_blocking</span><span class="p">(</span><span class="bp">self</span><span
            class="p">):</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_13monitor_current_greenlet_blocking, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer_monitor_current_g, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__12));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 98, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_monitor_current_greenlet_blockin, __pyx_t_2) &lt; 0) <span
  ...
  __pyx_codeobj__12 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__11, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_monitor_current_greenlet_blockin, 98, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 98, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">099</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">active_greenlet</span> <span
            class="o">=</span> <span class="n">getcurrent</span><span class="p">()</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-60"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">101</span>:     <span class="k">def</span> <span class="nf">did_block_hub_report</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">,</span> <span class="n">active_greenlet</span><span class="p">,</span> <span class="n">format_kwargs</span><span
            class="p">):</span></pre>
...
static PyObject *__pyx_pw_6gevent_8__tracer_14GreenletTracer_15did_block_hub_report(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = <span class='pyx_c_api'>__Pyx_PyDict_GetItemStr</span>(__pyx_kwds, __pyx_n_s_active_greenlet)) != 0)) kw_args--;
          ...
          <span class='pyx_c_api'>__Pyx_RaiseArgtupleInvalid</span>("did_block_hub_report", 1, 3, 3, 1); <span
                class='error_goto'>__PYX_ERR(0, 101, __pyx_L3_error)</span>
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = <span class='pyx_c_api'>__Pyx_PyDict_GetItemStr</span>(__pyx_kwds, __pyx_n_s_format_kwargs)) != 0)) kw_args--;
        else {
          <span class='pyx_c_api'>__Pyx_RaiseArgtupleInvalid</span>("did_block_hub_report", 1, 3, 3, 2); <span
                class='error_goto'>__PYX_ERR(0, 101, __pyx_L3_error)</span>
        }
      }
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "did_block_hub_report") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 101, __pyx_L3_error)</span>
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  <span class='pyx_c_api'>__Pyx_RaiseArgtupleInvalid</span>("did_block_hub_report", 1, 3, 3, <span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args)); <span
                class='error_goto'>__PYX_ERR(0, 101, __pyx_L3_error)</span>
  __pyx_L3_error:;
...
/* … */
  __pyx_tuple__13 = <span class='py_c_api'>PyTuple_Pack</span>(7, __pyx_n_s_self, __pyx_n_s_hub, __pyx_n_s_active_greenlet, __pyx_n_s_format_kwargs, __pyx_n_s_report, __pyx_n_s_frame, __pyx_n_s_stack);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__13)) __PYX_ERR(0, 101, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__13);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__13);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_14GreenletTracer_15did_block_hub_report, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_GreenletTracer_did_block_hub_rep, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__14));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 101, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer-&gt;tp_dict, __pyx_n_s_did_block_hub_report, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 101, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_GreenletTracer);
  __pyx_codeobj__14 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(4, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_did_block_hub_report, 101, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__14)) __PYX_ERR(0, 101, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">102</span>:         <span class="n">report</span> <span class="o">=</span> <span class="p">[</span><span
            class="s">&#39;=&#39;</span> <span class="o">*</span> <span class="mf">80</span><span
            class="p">,</span></pre>
    <pre class='cython code score-8 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(2);<span
  ...
  __pyx_t_2 = 0;
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">103</span>:                   <span class="s">&#39;</span><span class="se">\n</span><span
            class="si">%s</span><span class="s"> : Greenlet </span><span class="si">%s</span><span class="s"> appears to be blocked&#39;</span> <span
            class="o">%</span></pre>
    <pre class='cython code score-3 '>  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_s_Greenlet_s_appears_to_be_bloc, __pyx_t_2);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-25"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">104</span>:                   <span class="p">(</span><span class="n">gmctime</span><span
            class="p">(),</span> <span class="n">active_greenlet</span><span class="p">)]</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">105</span>:         <span class="n">report</span><span class="o">.</span><span
            class="n">append</span><span class="p">(</span><span class="s">&quot;    Reported by </span><span
            class="si">%s</span><span class="s">&quot;</span> <span class="o">%</span> <span class="p">(</span><span
            class="bp">self</span><span class="p">,))</span></pre>
    <pre class='cython code score-13 '>  __pyx_t_2 = <span class='py_c_api'>PyTuple_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 105, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_Reported_by_s, __pyx_t_2);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 105, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-4"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">106</span>:         <span class="k">try</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-24"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">107</span>:             <span class="n">frame</span> <span class="o">=</span> <span
            class="n">sys</span><span class="o">.</span><span class="n">_current_frames</span><span class="p">()[</span><span
            class="n">hub</span><span class="o">.</span><span class="n">thread_ident</span><span
            class="p">]</span></pre>
    <pre class='cython code score-24 '>      __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_6gevent_8__tracer_sys, __pyx_n_s_current_frames);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 107, __pyx_L3_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      __pyx_t_3 = NULL;
      if (CYTHON_UNPACK_METHODS &amp;&amp; likely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_2))) {
        __pyx_t_3 = <span class='py_macro_api'>PyMethod_GET_SELF</span>(__pyx_t_2);
      ...
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_hub, __pyx_n_s_thread_ident);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 107, __pyx_L3_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
    ...
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">108</span>:         <span class="k">except</span> <span class="ne">KeyError</span><span
            class="p">:</span></pre>
    ...
    if (__pyx_t_8) {
      ...
      if (<span class='pyx_c_api'>__Pyx_GetException</span>(&amp;__pyx_t_3, &amp;__pyx_t_2, &amp;__pyx_t_1) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 108, __pyx_L5_except_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">109</span>:             <span class="c"># The thread holding the hub has died. Perhaps we shouldn&#39;t</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">110</span>:             <span
            class="c"># even report this?</span></pre>
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">111</span>:             <span class="n">stack</span> <span class="o">=</span> <span
            class="p">[</span><span class="s">&quot;Unknown: No thread found for hub </span><span
            class="si">%r</span><span class="se">\n</span><span class="s">&quot;</span> <span class="o">%</span> <span
            class="p">(</span><span class="n">hub</span><span class="p">,)]</span></pre>
    <pre class='cython code score-19 '>      __pyx_t_9 = <span class='py_c_api'>PyTuple_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 111, __pyx_L5_except_error)</span>
      ...
      __pyx_t_10 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_Unknown_No_thread_found_for_hub, __pyx_t_9);<span
                class='error_goto'> if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 111, __pyx_L5_except_error)</span>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">112</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-22"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">113</span>:             <span class="n">stack</span> <span class="o">=</span> <span class="n">traceback</span><span
            class="o">.</span><span class="n">format_stack</span><span class="p">(</span><span
            class="n">frame</span><span class="p">)</span></pre>
    <pre class='cython code score-22 '>    /*else:*/ {
      __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_6gevent_8__tracer_traceback, __pyx_n_s_format_stack);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 113, __pyx_L5_except_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      __pyx_t_1 = NULL;
      if (CYTHON_UNPACK_METHODS &amp;&amp; likely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_2))) {
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">114</span>:         <span class="n">report</span><span class="o">.</span><span
            class="n">append</span><span class="p">(</span><span
            class="s">&#39;Blocked Stack (for thread id </span><span class="si">%s</span><span class="s">):&#39;</span> <span
            class="o">%</span> <span class="p">(</span><span class="nb">hex</span><span class="p">(</span><span
            class="n">hub</span><span class="o">.</span><span class="n">thread_ident</span><span
            class="p">),))</span></pre>
    <pre class='cython code score-17 '>  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_hub, __pyx_n_s_thread_ident);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 114, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_builtin_hex, __pyx_t_1);<span
  ...
  __pyx_t_2 = 0;
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_Blocked_Stack_for_thread_id_s, __pyx_t_1);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 114, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">115</span>:         <span class="n">report</span><span class="o">.</span><span
            class="n">append</span><span class="p">(</span><span class="s">&#39;&#39;</span><span
            class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">stack</span><span
            class="p">))</span></pre>
    <pre class='cython code score-5 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyString_Join</span>(__pyx_kp_s__2, __pyx_v_stack);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">116</span>:         <span class="n">report</span><span class="o">.</span><span
            class="n">append</span><span class="p">(</span><span class="s">&quot;Info:&quot;</span><span
            class="p">)</span></pre>
    <pre class='cython code score-2 '>  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyList_Append</span>(__pyx_v_report, __pyx_kp_s_Info);<span
            class='error_goto'> if (unlikely(__pyx_t_4 == ((int)-1))) __PYX_ERR(0, 116, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-26"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">117</span>:         <span class="n">report</span><span class="o">.</span><span
            class="n">extend</span><span class="p">(</span><span class="n">format_run_info</span><span
            class="p">(</span><span class="o">**</span><span class="n">format_kwargs</span><span
            class="p">))</span></pre>
  ...
  if (likely(<span class='py_c_api'>PyDict_CheckExact</span>(__pyx_v_format_kwargs))) {
    ...
    __pyx_t_2 = <span class='py_c_api'>PyObject_CallFunctionObjArgs</span>((PyObject*)&amp;PyDict_Type, __pyx_v_format_kwargs, NULL);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 117, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  }
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_v_6gevent_8__tracer_format_run_info, __pyx_empty_tuple, __pyx_t_2);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">119</span>:         <span class="k">return</span> <span class="n">report</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">122</span>: <span class="k">class</span> <span class="nc">_HubTracer</span><span class="p">(</span><span
            class="n">GreenletTracer</span><span class="p">):</span></pre>
...
static struct __pyx_vtabstruct_6gevent_8__tracer__HubTracer *__pyx_vtabptr_6gevent_8__tracer__HubTracer;
    ...
    <pre class="cython line score-29"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">123</span>:     <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span class="p">,</span> <span
            class="n">max_blocking_time</span><span class="p">):</span></pre>
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__init__") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 123, __pyx_L3_error)</span>
      }
    } else if (<span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">124</span>:         <span class="n">GreenletTracer</span><span class="o">.</span><span class="n">__init__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">)</span></pre>
    <pre class='cython code score-17 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_8__tracer_GreenletTracer), __pyx_n_s_init);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">125</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">max_blocking_time</span> <span
            class="o">=</span> <span class="n">max_blocking_time</span></pre>
    <pre class='cython code score-10 '>  __pyx_t_4 = __pyx_<span class='py_c_api'>PyFloat_AsDouble</span>(__pyx_v_max_blocking_time); if (unlikely((__pyx_t_4 == (double)-1) &amp;&amp; <span
            class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 125, __pyx_L1_error)</span>
  __pyx_v_self-&gt;max_blocking_time = __pyx_t_4;
</pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">126</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">hub</span> <span
  ...
  __pyx_v_self-&gt;hub = __pyx_v_hub;
    ...
    <pre class="cython line score-63"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">128</span>:     <span class="k">def</span> <span class="nf">kill</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_8__tracer_10_HubTracer_kill(struct __pyx_obj_6gevent_8__tracer__HubTracer *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      __pyx_t_1 = <span
                class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_kill);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 128, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_10_HubTracer_3kill, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_HubTracer_kill, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__16));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 128, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer__HubTracer-&gt;tp_dict, __pyx_n_s_kill, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 128, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer__HubTracer);
  __pyx_codeobj__16 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__15, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_kill, 128, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__16)) __PYX_ERR(0, 128, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">129</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">hub</span> <span
            class="o">=</span> <span class="bp">None</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GIVEREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;hub);
  ...
  __pyx_v_self-&gt;hub = Py_None;
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">130</span>:         <span class="n">GreenletTracer</span><span class="o">.</span><span class="n">kill</span><span
            class="p">(</span><span class="bp">self</span><span class="p">)</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = __pyx_f_6gevent_8__tracer_14GreenletTracer_kill(((struct __pyx_obj_6gevent_8__tracer_GreenletTracer *)__pyx_v_self), 1);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 130, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
</pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">133</span>: <span class="k">class</span> <span class="nc">HubSwitchTracer</span><span
            class="p">(</span><span class="n">_HubTracer</span><span class="p">):</span></pre>
...
static struct __pyx_vtabstruct_6gevent_8__tracer_HubSwitchTracer *__pyx_vtabptr_6gevent_8__tracer_HubSwitchTracer;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">134</span>:     <span class="c"># A greenlet tracer that records the last time we switched *into* the hub.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">135</span>: </pre>
    <pre class="cython line score-30"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">136</span>:     <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span class="p">,</span> <span
            class="n">max_blocking_time</span><span class="p">):</span></pre>
...
static int __pyx_pw_6gevent_8__tracer_15HubSwitchTracer_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("__init__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__init__") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 136, __pyx_L3_error)</span>
      }
    } else if (<span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-42"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">137</span>:         <span class="n">_HubTracer</span><span class="o">.</span><span class="n">__init__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">,</span> <span class="n">max_blocking_time</span><span class="p">)</span></pre>
    <pre class='cython code score-42 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_8__tracer__HubTracer), __pyx_n_s_init);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 137, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  __pyx_t_3 = NULL;
  __pyx_t_4 = 0;
  if (CYTHON_UNPACK_METHODS &amp;&amp; likely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_2))) {
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">138</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">last_entered_hub</span> <span
            class="o">=</span> <span class="mf">0</span></pre>
    <pre class='cython code score-0 '>  __pyx_v_self-&gt;last_entered_hub = 0.0;
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">139</span>: </pre>
    <pre class="cython line score-113"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">140</span>:     <span class="k">def</span> <span class="nf">_trace</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">event</span><span
            class="p">,</span> <span class="n">args</span><span class="p">):</span></pre>
...
static PyObject *__pyx_pw_6gevent_8__tracer_15HubSwitchTracer_3_trace(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_trace") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 140, __pyx_L3_error)</span>
      }
    } else if (<span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
...
static PyObject *__pyx_pf_6gevent_8__tracer_15HubSwitchTracer_2_trace(struct __pyx_obj_6gevent_8__tracer_HubSwitchTracer *__pyx_v_self, PyObject *__pyx_v_event, PyObject *__pyx_v_args) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_15HubSwitchTracer__trace(__pyx_v_self, __pyx_v_event, __pyx_v_args, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__17 = <span class='py_c_api'>PyTuple_Pack</span>(3, __pyx_n_s_self, __pyx_n_s_event, __pyx_n_s_args);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__17);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__17);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_15HubSwitchTracer_3_trace, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_HubSwitchTracer__trace, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__18));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_HubSwitchTracer-&gt;tp_dict, __pyx_n_s_trace, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_HubSwitchTracer);
  __pyx_codeobj__18 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(3, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__17, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_trace, 140, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__18)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">141</span>:         <span class="n">GreenletTracer</span><span class="o">.</span><span class="n">_trace</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">event</span><span
            class="p">,</span> <span class="n">args</span><span class="p">)</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = __pyx_f_6gevent_8__tracer_14GreenletTracer__trace(((struct __pyx_obj_6gevent_8__tracer_GreenletTracer *)__pyx_v_self), __pyx_v_event, __pyx_v_args, 1);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            ...
            class="o">.</span><span class="n">active_greenlet</span> <span class="ow">is</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">hub</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-28"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">143</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">last_entered_hub</span> <span
            class="o">=</span> <span class="n">perf_counter</span><span class="p">()</span></pre>
    ...
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_9 = __pyx_<span class='py_c_api'>PyFloat_AsDouble</span>(__pyx_t_1); if (unlikely((__pyx_t_9 == (double)-1) &amp;&amp; <span
                class='py_c_api'>PyErr_Occurred</span>())) <span
                class='error_goto'>__PYX_ERR(0, 143, __pyx_L1_error)</span>
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-61"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">145</span>:     <span class="k">def</span> <span class="nf">did_block_hub</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">):</span></pre>
...
static PyObject *__pyx_pf_6gevent_8__tracer_15HubSwitchTracer_4did_block_hub(struct __pyx_obj_6gevent_8__tracer_HubSwitchTracer *__pyx_v_self, PyObject *__pyx_v_hub) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("did_block_hub", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_15HubSwitchTracer_did_block_hub(__pyx_v_self, __pyx_v_hub, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__19 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_hub);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__19);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__19);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_15HubSwitchTracer_5did_block_hub, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_HubSwitchTracer_did_block_hub, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__20));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_HubSwitchTracer-&gt;tp_dict, __pyx_n_s_did_block_hub, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 145, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_HubSwitchTracer);
  __pyx_codeobj__20 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_did_block_hub, 145, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-44"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">146</span>:         <span class="k">if</span> <span class="n">perf_counter</span><span
            class="p">()</span> <span class="o">-</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">last_entered_hub</span> <span class="o">&gt;</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">max_blocking_time</span><span class="p">:</span></pre>
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = <span class='py_c_api'>PyFloat_FromDouble</span>(__pyx_v_self-&gt;last_entered_hub);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 146, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = <span class='py_c_api'>PyFloat_FromDouble</span>(__pyx_v_self-&gt;__pyx_base.max_blocking_time);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 146, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  __pyx_t_1 = <span class='py_c_api'>PyObject_RichCompare</span>(__pyx_t_3, __pyx_t_2, Py_GT); <span class='refnanny'>__Pyx_XGOTREF</span>(__pyx_t_1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 146, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_IsTrue</span>(__pyx_t_1); if (unlikely(__pyx_t_5 &lt; 0)) <span
...
/* … */
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">147</span>:             <span class="k">return</span> <span class="bp">True</span><span
            class="p">,</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">active_greenlet</span></pre>
    <pre class='cython code score-10 '>    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">150</span>: <span class="k">class</span> <span class="nc">MaxSwitchTracer</span><span
            class="p">(</span><span class="n">_HubTracer</span><span class="p">):</span></pre>
...
static struct __pyx_vtabstruct_6gevent_8__tracer_MaxSwitchTracer *__pyx_vtabptr_6gevent_8__tracer_MaxSwitchTracer;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">151</span>:     <span class="c"># A greenlet tracer that records the maximum time between switches,</span></pre>
    ...
    <pre class="cython line score-30"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">154</span>:     <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span class="p">,</span> <span
            class="n">max_blocking_time</span><span class="p">):</span></pre>
    <pre class='cython code score-30 '>/* Python wrapper */
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-42"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">155</span>:         <span class="n">_HubTracer</span><span class="o">.</span><span class="n">__init__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">,</span> <span class="n">max_blocking_time</span><span class="p">)</span></pre>
    <pre class='cython code score-42 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_8__tracer__HubTracer), __pyx_n_s_init);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-28"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">156</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">last_switch</span> <span class="o">=</span> <span class="n">perf_counter</span><span
            class="p">()</span></pre>
    <pre class='cython code score-28 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_6gevent_8__tracer_perf_counter);
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __pyx_<span class='py_c_api'>PyFloat_AsDouble</span>(__pyx_t_1); if (unlikely((__pyx_t_6 == (double)-1) &amp;&amp; <span
                class='py_c_api'>PyErr_Occurred</span>())) <span
  ...
  __pyx_v_self-&gt;last_switch = __pyx_t_6;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">157</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">max_blocking</span> <span
            class="o">=</span> <span class="mf">0</span></pre>
    ...
    <pre class="cython line score-114"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">159</span>:     <span class="k">def</span> <span class="nf">_trace</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">event</span><span
            class="p">,</span> <span class="n">args</span><span class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_8__tracer_15MaxSwitchTracer__trace(struct __pyx_obj_6gevent_8__tracer_MaxSwitchTracer *__pyx_v_self, PyObject *__pyx_v_event, PyObject *__pyx_v_args, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_trace);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
...
static PyObject *__pyx_pw_6gevent_8__tracer_15MaxSwitchTracer_3_trace(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_trace") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 159, __pyx_L3_error)</span>
      }
    } else if (<span class='py_macro_api'>PyTuple_GET_SIZE</span>(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
...
static PyObject *__pyx_pf_6gevent_8__tracer_15MaxSwitchTracer_2_trace(struct __pyx_obj_6gevent_8__tracer_MaxSwitchTracer *__pyx_v_self, PyObject *__pyx_v_event, PyObject *__pyx_v_args) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_trace", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_15MaxSwitchTracer__trace(__pyx_v_self, __pyx_v_event, __pyx_v_args, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__21 = <span class='py_c_api'>PyTuple_Pack</span>(3, __pyx_n_s_self, __pyx_n_s_event, __pyx_n_s_args);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__21);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__21);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_15MaxSwitchTracer_3_trace, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_MaxSwitchTracer__trace, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__22));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_MaxSwitchTracer-&gt;tp_dict, __pyx_n_s_trace, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 159, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_MaxSwitchTracer);
  __pyx_codeobj__22 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(3, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__tracer_py, __pyx_n_s_trace, 159, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">160</span>:         <span class="n">old_active</span> <span class="o">=</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">active_greenlet</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">161</span>:         <span class="n">GreenletTracer</span><span class="o">.</span><span class="n">_trace</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">event</span><span
            class="p">,</span> <span class="n">args</span><span class="p">)</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = __pyx_f_6gevent_8__tracer_14GreenletTracer__trace(((struct __pyx_obj_6gevent_8__tracer_GreenletTracer *)__pyx_v_self), __pyx_v_event, __pyx_v_args, 1);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">162</span>:         <span class="k">if</span> <span class="n">old_active</span> <span
            class="ow">is</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">hub</span> <span class="ow">and</span> <span class="n">old_active</span> <span
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">163</span>:             <span class="c"># If we&#39;re switching out of the hub, the blocking</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">164</span>:             <span class="c"># time doesn&#39;t count.</span></pre>
    <pre class="cython line score-28"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">165</span>:             <span class="n">switched_at</span> <span class="o">=</span> <span
            class="n">perf_counter</span><span class="p">()</span></pre>
    <pre class='cython code score-28 '>    <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_6gevent_8__tracer_perf_counter);
    __pyx_t_2 = __pyx_v_6gevent_8__tracer_perf_counter; __pyx_t_3 = NULL;
    if (CYTHON_UNPACK_METHODS &amp;&amp; unlikely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_2))) {
      __pyx_t_3 = <span class='py_macro_api'>PyMethod_GET_SELF</span>(__pyx_t_2);
    ...
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_10 = __pyx_<span class='py_c_api'>PyFloat_AsDouble</span>(__pyx_t_1); if (unlikely((__pyx_t_10 == (double)-1) &amp;&amp; <span
                class='py_c_api'>PyErr_Occurred</span>())) <span
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">166</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">max_blocking</span> <span
            class="o">=</span> <span class="nb">max</span><span class="p">(</span><span class="bp">self</span><span
            class="o">.</span><span class="n">max_blocking</span><span class="p">,</span></pre>
...
/* … */
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">167</span>:                                     <span class="n">switched_at</span> <span class="o">-</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">last_switch</span><span
            class="p">)</span></pre>
...
/* … */
    ...
    <pre class="cython line score-59"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">169</span>:     <span class="k">def</span> <span class="nf">did_block_hub</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span
            class="p">):</span></pre>
...
static PyObject *__pyx_f_6gevent_8__tracer_15MaxSwitchTracer_did_block_hub(struct __pyx_obj_6gevent_8__tracer_MaxSwitchTracer *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_hub, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_did_block_hub);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 169, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
...
static PyObject *__pyx_pf_6gevent_8__tracer_15MaxSwitchTracer_4did_block_hub(struct __pyx_obj_6gevent_8__tracer_MaxSwitchTracer *__pyx_v_self, PyObject *__pyx_v_hub) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("did_block_hub", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_8__tracer_15MaxSwitchTracer_did_block_hub(__pyx_v_self, __pyx_v_hub, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 169, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
...
/* … */
  __pyx_tuple__23 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_hub);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 169, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__23);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__23);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__tracer_15MaxSwitchTracer_5did_block_hub, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_MaxSwitchTracer_did_block_hub, NULL, __pyx_n_s_gevent___tracer, __pyx_d, ((PyObject *)__pyx_codeobj__24));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 169, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__tracer_MaxSwitchTracer-&gt;tp_dict, __pyx_n_s_did_block_hub, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 169, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__tracer_MaxSwitchTracer);
</pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            ...
            class="o">.</span><span class="n">max_blocking</span> <span class="o">==</span> <span
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">171</span>:             <span class="c"># We never switched. Check the time now</span></pre>
    <pre class="cython line score-40"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">172</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">max_blocking</span> <span
            class="o">=</span> <span class="n">perf_counter</span><span class="p">()</span> <span
            class="o">-</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">last_switch</span></pre>
    ...
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_6 = __pyx_<span class='py_c_api'>PyFloat_AsDouble</span>(__pyx_t_3); if (unlikely((__pyx_t_6 == (double)-1) &amp;&amp; <span
                class='py_c_api'>PyErr_Occurred</span>())) <span
                class='error_goto'>__PYX_ERR(0, 172, __pyx_L1_error)</span>
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">174</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">max_blocking</span> <span class="o">&gt;</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">max_blocking_time</span><span
            class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">175</span>:             <span class="k">return</span> <span class="bp">True</span><span
            class="p">,</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">active_greenlet</span></pre>
    <pre class='cython code score-10 '>    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
    ...
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">178</span>: <span class="k">from</span> <span class="nn">gevent._util</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">179</span>: <span class="n">import_c_accel</span><span class="p">(</span><span
            class="nb">globals</span><span class="p">(),</span> <span class="s">&#39;gevent.__tracer&#39;</span><span
            class="p">)</span></pre>
    <pre class='cython code score-17 '>  <span class='pyx_c_api'>__Pyx_GetModuleGlobalName</span>(__pyx_t_1, __pyx_n_s_import_c_accel);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 179, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
