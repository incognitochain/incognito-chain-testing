...
<div class="cython">
    <pre class="cython line score-0">&#xA0;<span class="">01</span>: <span
            class="c"># -*- coding: utf-8 -*-</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">02</span>: <span class="c"># Copyright 2018 gevent contributors. See LICENSE for details.</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">05</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
            class="k">import</span> <span class="n">absolute_import</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">06</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
            class="k">import</span> <span class="n">division</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">07</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">10</span>: <span class="k">from</span> <span class="nn">weakref</span> <span
            class="k">import</span> <span class="n">WeakKeyDictionary</span></pre>
  ...
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_ImportFrom</span>(__pyx_t_2, __pyx_n_s_WeakKeyDictionary);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-11"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">11</span>: <span class="k">from</span> <span class="nn">weakref</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">13</span>: <span class="k">from</span> <span class="nn">heapq</span> <span class="k">import</span> <span
            class="n">heappop</span></pre>
    <pre class='cython code score-16 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">14</span>: <span class="k">from</span> <span class="nn">heapq</span> <span class="k">import</span> <span
            class="n">heappush</span></pre>
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">16</span>: <span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span></pre>
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">17</span>:     <span
            class="s">&#39;IdentRegistry&#39;</span><span class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">18</span>: <span class="p">]</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">19</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">20</span>: <span class="k">class</span> <span class="nc">ValuedWeakRef</span><span
            class="p">(</span><span class="n">ref</span><span class="p">):</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">21</span>:     <span
            class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">22</span>: <span class="sd">    A weak ref with an associated value.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">23</span>: <span
            class="sd">    &quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">24</span>: </pre>
    <pre class="cython line score-15"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">25</span>:     <span class="n">__slots__</span> <span class="o">=</span> <span
            class="p">(</span><span class="s">&#39;value&#39;</span><span class="p">,)</span></pre>
    <pre class='cython code score-15 '>  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_7__ident_ValuedWeakRef-&gt;tp_dict, __pyx_n_s_slots, __pyx_tuple_) &lt; 0) <span
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple_);
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">28</span>: <span class="k">class</span> <span class="nc">IdentRegistry</span><span
...
static struct __pyx_vtabstruct_6gevent_7__ident_IdentRegistry *__pyx_vtabptr_6gevent_7__ident_IdentRegistry;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">29</span>:     <span
            class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">30</span>: <span class="sd">    Maintains a unique mapping of (small) positive integer identifiers</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">31</span>: <span class="sd">    to objects that can be weakly referenced.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">32</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">33</span>: <span class="sd">    It is guaranteed that no two objects will have the the same</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">34</span>: <span class="sd">    identifier at the same time, as long as those objects are</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">35</span>: <span class="sd">    also uniquely hashable.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">36</span>: <span
            class="sd">    &quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">37</span>: </pre>
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">38</span>:     <span class="k">def</span> <span class="nf">__init__</span><span
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">39</span>:         <span class="c"># {obj -&gt; (ident, wref(obj))}</span></pre>
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">40</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_registry</span> <span class="o">=</span> <span class="n">WeakKeyDictionary</span><span class="p">()</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">42</span>:         <span class="c"># A heap of numbers that have been used and returned</span></pre>
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">43</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">_available_idents</span> <span
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-31"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">45</span>:     <span class="k">def</span> <span class="nf">get_ident</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">obj</span><span class="p">):</span></pre>
...
/* … */
  __pyx_tuple__2 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_obj);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 45, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__2);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__2);
/* … */
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_7__ident_13IdentRegistry_3get_ident, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_IdentRegistry_get_ident, NULL, __pyx_n_s_gevent___ident, __pyx_d, ((PyObject *)__pyx_codeobj__3));<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_7__ident_IdentRegistry-&gt;tp_dict, __pyx_n_s_get_ident, __pyx_t_1) &lt; 0) <span
  ...
  __pyx_codeobj__3 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__2, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__ident_py, __pyx_n_s_get_ident, 45, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__3)) __PYX_ERR(0, 45, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">46</span>:         <span class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">47</span>: <span class="sd">        Retrieve the identifier for *obj*, creating one</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">48</span>: <span class="sd">        if necessary.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">49</span>: <span class="sd">        &quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">50</span>: </pre>
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">51</span>:         <span class="k">try</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">52</span>:             <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_registry</span><span class="p">[</span><span class="n">obj</span><span
            class="p">][</span><span class="mf">0</span><span class="p">]</span></pre>
    <pre class='cython code score-6 '>      <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
      __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyObject_GetItem</span>(__pyx_v_self-&gt;_registry, __pyx_v_obj);<span
                class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L3_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
      __pyx_t_5 = <span class='pyx_c_api'>__Pyx_GetItemInt</span>(__pyx_t_4, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1);<span
                class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 52, __pyx_L3_error)</span>
    ...
    <pre class="cython line score-4"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">53</span>:         <span class="k">except</span> <span class="ne">KeyError</span><span
            class="p">:</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">54</span>:             <span class="k">pass</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">55</span>: </pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">56</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_available_idents</span><span class="p">:</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_7 = (__pyx_v_self-&gt;_available_idents != Py_None)&amp;&amp;(<span
            class='py_macro_api'>PyList_GET_SIZE</span>(__pyx_v_self-&gt;_available_idents) != 0);
  if (__pyx_t_7) {
/* … */
    goto __pyx_L9;
  }
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">57</span>:             <span class="c"># Take the smallest free number</span></pre>
    <pre class="cython line score-15"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">58</span>:             <span class="n">ident</span> <span class="o">=</span> <span class="n">heappop</span><span
            class="p">(</span><span class="bp">self</span><span class="o">.</span><span
            class="n">_available_idents</span><span class="p">)</span></pre>
    ...
    __pyx_t_5 = (__pyx_t_8) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_8, __pyx_v_self-&gt;_available_idents) : <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_4, __pyx_v_self-&gt;_available_idents);
    ...
    <pre class="cython line score-0">&#xA0;<span class="">59</span>:         <span class="k">else</span><span class="p">:</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">60</span>:             <span
            class="c"># Allocate a bigger one</span></pre>
    <pre class="cython line score-12"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">61</span>:             <span class="n">ident</span> <span class="o">=</span> <span
            class="nb">len</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span
            class="n">_registry</span><span class="p">)</span></pre>
  ...
  __pyx_L9:;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">62</span>: </pre>
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">63</span>:         <span class="n">vref</span> <span class="o">=</span> <span class="n">ValuedWeakRef</span><span
            class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_return_ident</span><span class="p">)</span></pre>
    <pre class='cython code score-13 '>  __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_return_ident);<span
            class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 63, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
  ...
  __pyx_t_5 = 0;
  __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(((PyObject *)__pyx_ptype_6gevent_7__ident_ValuedWeakRef), __pyx_t_4, NULL);<span
                class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 63, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __pyx_t_5 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">64</span>:         <span class="n">vref</span><span class="o">.</span><span class="n">value</span> <span
            class="o">=</span> <span class="n">ident</span> <span class="c"># pylint:disable=assigning-non-slot,attribute-defined-outside-init</span></pre>
  ...
  __pyx_v_vref-&gt;value = __pyx_v_ident;
    ...
    <pre class="cython line score-15"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">65</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_registry</span><span class="p">[</span><span class="n">obj</span><span class="p">]</span> <span
            class="o">=</span> <span class="p">(</span><span class="n">ident</span><span class="p">,</span> <span
            class="n">vref</span><span class="p">)</span></pre>
    <pre class='cython code score-15 '>  __pyx_t_5 = <span class='py_c_api'>PyTuple_New</span>(2);<span
            class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 65, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
  ...
  if (unlikely(<span class='py_c_api'>PyObject_SetItem</span>(__pyx_v_self-&gt;_registry, __pyx_v_obj, __pyx_t_5) &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 65, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_5); __pyx_t_5 = 0;
</pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">66</span>:         <span class="k">return</span> <span class="n">ident</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_ident);
  __pyx_r = __pyx_v_ident;
  goto __pyx_L0;
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">67</span>: </pre>
    <pre class="cython line score-31"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">68</span>:     <span class="k">def</span> <span class="nf">_return_ident</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">vref</span><span
            class="p">):</span></pre>
...
static PyObject *__pyx_pw_6gevent_7__ident_13IdentRegistry_5_return_ident(PyObject *__pyx_v_self, PyObject *__pyx_v_vref) {
  ...
  if (unlikely(!<span class='pyx_c_api'>__Pyx_ArgTypeTest</span>(((PyObject *)__pyx_v_vref), __pyx_ptype_6gevent_7__ident_ValuedWeakRef, 1, "vref", 0))) <span
...
static PyObject *__pyx_pf_6gevent_7__ident_13IdentRegistry_4_return_ident(struct __pyx_obj_6gevent_7__ident_IdentRegistry *__pyx_v_self, struct __pyx_obj_6gevent_7__ident_ValuedWeakRef *__pyx_v_vref) {
  ...
  <span class='refnanny'>__Pyx_RefNannySetupContext</span>("_return_ident", 0);
  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_1 = __pyx_f_6gevent_7__ident_13IdentRegistry__return_ident(__pyx_v_self, __pyx_v_vref, 1);<span
...
/* … */
  __pyx_tuple__4 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_vref);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 68, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__4);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__4);
/* … */
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_7__ident_13IdentRegistry_5_return_ident, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_IdentRegistry__return_ident, NULL, __pyx_n_s_gevent___ident, __pyx_d, ((PyObject *)__pyx_codeobj__5));<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_7__ident_IdentRegistry-&gt;tp_dict, __pyx_n_s_return_ident, __pyx_t_1) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 68, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_7__ident_IdentRegistry);
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">69</span>:         <span class="c"># By the time this is called, self._registry has been</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">70</span>:         <span class="c"># updated</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">71</span>:         <span class="k">if</span> <span class="n">heappush</span> <span
...
/* … */
    ...
    <pre class="cython line score-0">&#xA0;<span class="">72</span>:             <span class="c"># Under some circumstances we can get called</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">73</span>:             <span class="c"># when the interpreter is shutting down, and globals</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">74</span>:             <span class="c"># aren&#39;t available any more.</span></pre>
    <pre class="cython line score-39"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">75</span>:             <span class="n">heappush</span><span class="p">(</span><span
            class="bp">self</span><span class="o">.</span><span class="n">_available_idents</span><span
            class="p">,</span> <span class="n">vref</span><span class="o">.</span><span class="n">value</span><span
            class="p">)</span></pre>
    ...
    if (<span class='py_c_api'>PyFunction_Check</span>(__pyx_t_4)) {
      ...
      __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyFunction_FastCall</span>(__pyx_t_4, __pyx_temp+1-__pyx_t_6, 2+__pyx_t_6);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 75, __pyx_L1_error)</span>
      <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_5); __pyx_t_5 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">76</span>: </pre>
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">77</span>:     <span class="k">def</span> <span class="nf">__len__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-7"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">78</span>:         <span class="k">return</span> <span class="nb">len</span><span
            class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_registry</span><span
            class="p">)</span></pre>
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">81</span>: <span class="k">from</span> <span class="nn">gevent._util</span> <span
    ...
    <pre class='cython code score-19 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">82</span>: <span class="n">import_c_accel</span><span class="p">(</span><span
            class="nb">globals</span><span class="p">(),</span> <span class="s">&#39;gevent.__ident&#39;</span><span
            class="p">)</span></pre>
