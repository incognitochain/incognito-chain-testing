...
class Test(unittest.TestCase):
    ...
    def check_implements_presence_justified(self):
        "Check that __implements__ is present only if the module is modeled after a module from stdlib (like
        gevent.socket)."
    ...
    def set_stdlib_all(self):
        ...
        if self.stdlib_all is None:
            ...
            self.stdlib_all = [name for name in self.stdlib_all if
                               not isinstance(getattr(self.stdlib_module, name), types.ModuleType)]
