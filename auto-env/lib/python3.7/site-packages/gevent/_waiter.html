...
<div class="cython">
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">002</span>: <span
            class="c"># copyright 2018 gevent</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">005</span>: <span
            class="sd">Low-level waiting primitives.</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">008</span>: <span class="k">from</span> <span class="nn">__future__</span> <span
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">012</span>: <span class="k">import</span> <span class="nn">sys</span></pre>
    <pre class='cython code score-3 '>  __pyx_t_1 = <span
            class='pyx_c_api'>__Pyx_Import</span>(__pyx_n_s_sys, 0, 0);<span class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">014</span>: <span class="k">from</span> <span class="nn">gevent._hub_local</span> <span class="k">import</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">015</span>: <span class="k">from</span> <span class="nn">gevent.exceptions</span> <span class="k">import</span> <span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">017</span>: <span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span></pre>
    <pre class='cython code score-13 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">018</span>:     <span class="s">&#39;Waiter&#39;</span><span
            class="p">,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">019</span>: <span class="p">]</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">020</span>: </pre>
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">021</span>: <span class="n">_NONE</span> <span class="o">=</span> <span
            class="nb">object</span><span class="p">()</span></pre>
    <pre class='cython code score-3 '>  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_CallNoArg</span>(__pyx_builtin_object);<span
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">023</span>: <span class="nb">locals</span><span class="p">()[</span><span class="s">&#39;getcurrent&#39;</span><span
    ...
    <pre class='cython code score-19 '>  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_builtin___import__, __pyx_tuple__2, NULL);<span
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__2);
    ...
    <pre class="cython line score-13"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">024</span>: <span class="nb">locals</span><span class="p">()[</span><span class="s">&#39;greenlet_init&#39;</span><span
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_2lambda, 0, __pyx_n_s_lambda, NULL, __pyx_n_s_gevent___waiter, __pyx_d, NULL);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">027</span>: <span class="k">class</span> <span class="nc">Waiter</span><span
...
static struct __pyx_vtabstruct_6gevent_8__waiter_Waiter *__pyx_vtabptr_6gevent_8__waiter_Waiter;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">028</span>:     <span
            class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">029</span>: <span class="sd">    A low level communication utility for greenlets.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">030</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">031</span>: <span class="sd">    Waiter is a wrapper around greenlet&#39;s ``switch()`` and ``throw()`` calls that makes them somewhat safer:</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">032</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">033</span>: <span class="sd">    * switching will occur only if the waiting greenlet is executing :meth:`get` method currently;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">034</span>: <span class="sd">    * any error raised in the greenlet is handled inside :meth:`switch` and :meth:`throw`</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">035</span>: <span class="sd">    * if :meth:`switch`/:meth:`throw` is called before the receiver calls :meth:`get`, then :class:`Waiter`</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">036</span>: <span class="sd">      will store the value/exception. The following :meth:`get` will return the value/raise the exception.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">037</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">038</span>: <span class="sd">    The :meth:`switch` and :meth:`throw` methods must only be called from the :class:`Hub` greenlet.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">039</span>: <span class="sd">    The :meth:`get` method must be called from a greenlet other than :class:`Hub`.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">040</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">041</span>: <span class="sd">        &gt;&gt;&gt; result = Waiter()</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">042</span>: <span class="sd">        &gt;&gt;&gt; timer = get_hub().loop.timer(0.1)</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">043</span>: <span class="sd">        &gt;&gt;&gt; timer.start(result.switch, &#39;hello from Waiter&#39;)</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">044</span>: <span class="sd">        &gt;&gt;&gt; result.get() # blocks for 0.1 seconds</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">045</span>: <span class="sd">        &#39;hello from Waiter&#39;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">046</span>: <span class="sd">        &gt;&gt;&gt; timer.close()</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">047</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">048</span>: <span class="sd">    If switch is called before the greenlet gets a chance to call :meth:`get` then</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">049</span>: <span class="sd">    :class:`Waiter` stores the value.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">050</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">051</span>: <span class="sd">        &gt;&gt;&gt; result = Waiter()</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">052</span>: <span class="sd">        &gt;&gt;&gt; timer = get_hub().loop.timer(0.1)</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">053</span>: <span class="sd">        &gt;&gt;&gt; timer.start(result.switch, &#39;hi from Waiter&#39;)</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">054</span>: <span
            class="sd">        &gt;&gt;&gt; sleep(0.2)</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">055</span>: <span class="sd">        &gt;&gt;&gt; result.get() # returns immediately without blocking</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">056</span>: <span
            class="sd">        &#39;hi from Waiter&#39;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">057</span>: <span class="sd">        &gt;&gt;&gt; timer.close()</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">058</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">059</span>: <span class="sd">    .. warning::</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">060</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">061</span>: <span class="sd">        This a limited and dangerous way to communicate between</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">062</span>: <span class="sd">        greenlets. It can easily leave a greenlet unscheduled forever</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">063</span>: <span class="sd">        if used incorrectly. Consider using safer classes such as</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">064</span>: <span class="sd">        :class:`gevent.event.Event`, :class:`gevent.event.AsyncResult`,</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">065</span>: <span class="sd">        or :class:`gevent.queue.Queue`.</span></pre>
    ...
    <pre class="cython line score-24"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">068</span>:     <span class="n">__slots__</span> <span class="o">=</span> <span
            class="p">[</span><span class="s">&#39;hub&#39;</span><span class="p">,</span> <span class="s">&#39;greenlet&#39;</span><span
            class="p">,</span> <span class="s">&#39;value&#39;</span><span class="p">,</span> <span class="s">&#39;_exception&#39;</span><span
            class="p">]</span></pre>
    <pre class='cython code score-24 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(4);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_slots, __pyx_t_2) &lt; 0) <span
  ...
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
    ...
    <pre class="cython line score-22"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">070</span>:     <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span
            class="bp">self</span><span class="p">,</span> <span class="n">hub</span><span class="o">=</span><span
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__init__") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 70, __pyx_L3_error)</span>
      }
    } else {
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-4"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">071</span>:         <span class="bp">self</span><span class="o">.</span><span class="n">hub</span> <span
            class="o">=</span> <span class="n">get_hub</span><span class="p">()</span> <span class="k">if</span> <span
            class="n">hub</span> <span class="ow">is</span> <span class="bp">None</span> <span
            class="k">else</span> <span class="n">hub</span></pre>
  ...
  if ((__pyx_t_2 != 0)) {
    ...
    if (!(likely(((__pyx_v_hub) == Py_None) || likely(<span class='pyx_c_api'>__Pyx_TypeTest</span>(__pyx_v_hub, __pyx_ptype_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop))))) <span
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">072</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">greenlet</span> <span class="o">=</span> <span class="bp">None</span></pre>
  ...
  __pyx_v_self-&gt;greenlet = ((PyGreenlet *)Py_None);
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">073</span>:         <span class="bp">self</span><span class="o">.</span><span
  ...
  __pyx_v_self-&gt;value = Py_None;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">074</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_exception</span> <span class="o">=</span> <span class="n">_NONE</span></pre>
  ...
  __pyx_v_self-&gt;_exception = __pyx_v_6gevent_8__waiter__NONE;
    ...
    <pre class="cython line score-63"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">076</span>:     <span class="k">def</span> <span class="nf">clear</span><span
...
static PyObject *__pyx_f_6gevent_8__waiter_6Waiter_clear(struct __pyx_obj_6gevent_8__waiter_Waiter *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (likely(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict &amp;&amp; tp_dict_version == __PYX_GET_DICT_VERSION(Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dict) &amp;&amp; (!Py_TYPE(((PyObject *)__pyx_v_self))-&gt;tp_dictoffset || obj_dict_version == __PYX_GET_DICT_VERSION(_<span
      ...
      #endif
      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_clear);<span
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_3clear, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_clear, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__4));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 76, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_clear, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 76, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__4 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_clear, 76, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 76, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">077</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">greenlet</span> <span class="o">=</span> <span class="bp">None</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GIVEREF</span>(Py_None);
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;greenlet);
  ...
  __pyx_v_self-&gt;value = Py_None;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">079</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_exception</span> <span class="o">=</span> <span class="n">_NONE</span></pre>
    <pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_6gevent_8__waiter__NONE);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_v_6gevent_8__waiter__NONE);
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;_exception);
  ...
  __pyx_v_self-&gt;_exception = __pyx_v_6gevent_8__waiter__NONE;
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">081</span>:     <span class="k">def</span> <span class="nf">__str__</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">082</span>:         <span class="k">if</span> <span class="bp">self</span><span
...
/* … */
    ...
    <pre class="cython line score-14"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">083</span>:             <span class="k">return</span> <span class="s">&#39;&lt;</span><span
            class="si">%s</span><span class="s"> greenlet=</span><span class="si">%s</span><span
            ...
            class="o">.</span><span class="n">greenlet</span><span class="p">)</span></pre>
    <pre class='cython code score-14 '>    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
    __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)Py_TYPE(((PyObject *)__pyx_v_self))), __pyx_n_s_name);<span
    ...
    __pyx_t_3 = 0;
    __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_s_greenlet_s, __pyx_t_4);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 83, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">084</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span
            class="bp">None</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">085</span>:             <span class="k">return</span> <span class="s">&#39;&lt;</span><span
            class="si">%s</span><span class="s"> greenlet=</span><span class="si">%s</span><span
            class="s"> value=</span><span class="si">%r</span><span class="s">&gt;&#39;</span> <span class="o">%</span> <span
            ...
            class="bp">self</span><span class="o">.</span><span class="n">greenlet</span><span class="p">,</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">value</span><span class="p">)</span></pre>
    <pre class='cython code score-16 '>    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
    __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)Py_TYPE(((PyObject *)__pyx_v_self))), __pyx_n_s_name);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 85, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    ...
    __pyx_t_3 = 0;
    __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_s_greenlet_s_value_r, __pyx_t_4);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 85, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_r = __pyx_t_3;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">086</span>:         <span class="k">return</span> <span class="s">&#39;&lt;</span><span class="si">%s</span><span
            class="s"> greenlet=</span><span class="si">%s</span><span class="s"> exc_info=</span><span
            class="si">%r</span><span class="s">&gt;&#39;</span> <span class="o">%</span> <span class="p">(</span><span
            class="nb">type</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span
            class="o">.</span><span class="n">__name__</span><span class="p">,</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">greenlet</span><span class="p">,</span> <span class="bp">self</span><span
  ...
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)Py_TYPE(((PyObject *)__pyx_v_self))), __pyx_n_s_name);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  __pyx_t_4 = <span
                class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_exc_info);<span
                class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 86, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  ...
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_s_greenlet_s_exc_info_r, __pyx_t_5);<span
                class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 86, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-23"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">088</span>:     <span class="k">def</span> <span class="nf">ready</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_7ready, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_ready, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__6));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 88, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_ready, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 88, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__6 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__5, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_ready, 88, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__6)) __PYX_ERR(0, 88, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">089</span>:         <span class="sd">&quot;&quot;&quot;Return true if and only if it holds a value or an exception&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">090</span>:         <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-23"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">092</span>:     <span class="k">def</span> <span class="nf">successful</span><span
            class="p">(</span><span class="bp">self</span><span class="p">):</span></pre>
    <pre class='cython code score-23 '>/* Python wrapper */
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_9successful, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_successful, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__8));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 92, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_successful, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 92, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__8 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_successful, 92, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 92, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">093</span>:         <span class="sd">&quot;&quot;&quot;Return true if and only if it is ready and holds a value&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">094</span>:         <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span class="bp">None</span></pre>
    <pre class='cython code score-3 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">096</span>:     <span class="nd">@property</span></pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">097</span>:     <span class="k">def</span> <span class="nf">exc_info</span><span class="p">(</span><span
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">098</span>:         <span class="s">&quot;Holds the exception info passed to :meth:`throw` if :meth:`throw` was called. Otherwise ``None``.&quot;</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">099</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span
            class="ow">not</span> <span class="n">_NONE</span><span class="p">:</span></pre>
    <pre class='cython code score-0 '>  __pyx_t_1 = (__pyx_v_self-&gt;_exception != __pyx_v_6gevent_8__waiter__NONE);
  __pyx_t_2 = (__pyx_t_1 != 0);
  if (__pyx_t_2) {
/* … */
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">100</span>:             <span class="k">return</span> <span class="bp">self</span><span
    ...
    <pre class="cython line score-33"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">102</span>:     <span class="k">def</span> <span class="nf">switch</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">value</span><span
            class="p">):</span></pre>
...
/* … */
  __pyx_tuple__9 = <span class='py_c_api'>PyTuple_Pack</span>(4, __pyx_n_s_self, __pyx_n_s_value, __pyx_n_s_greenlet, __pyx_n_s_switch);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 102, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__9);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__9);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_11switch, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_switch, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__10));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 102, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_switch, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 102, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__10 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_switch, 102, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 102, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">103</span>:         <span class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">104</span>: <span class="sd">        Switch to the greenlet if one&#39;s available. Otherwise store the</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">105</span>: <span class="sd">        *value*.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">106</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">107</span>: <span
            class="sd">        .. versionchanged:: 1.3b1</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">108</span>: <span class="sd">           The *value* is no longer optional.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">109</span>: <span class="sd">        &quot;&quot;&quot;</span></pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">110</span>:         <span class="n">greenlet</span> <span class="o">=</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">greenlet</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">111</span>:         <span class="k">if</span> <span class="n">greenlet</span> <span
...
/* … */
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">112</span>:             <span class="bp">self</span><span class="o">.</span><span
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">113</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">_exception</span> <span
    ...
    <pre class="cython line score-0">&#xA0;<span class="">114</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">115</span>:             <span class="k">if</span> <span class="n">getcurrent</span><span class="p">()</span> <span
            class="ow">is</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">hub</span><span class="p">:</span> <span
...
/* … */
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">116</span>:                 <span class="k">raise</span> <span
            class="ne">AssertionError</span><span class="p">(</span><span class="s">&quot;Can only use Waiter.switch method from the Hub greenlet&quot;</span><span
            class="p">)</span></pre>
    <pre class='cython code score-10 '>      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_builtin_AssertionError, __pyx_tuple_, NULL);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 116, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
      <span class='pyx_c_api'>__Pyx_Raise</span>(__pyx_t_1, 0, 0, 0);
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
      <span class='error_goto'>__PYX_ERR(0, 116, __pyx_L1_error)</span>
/* … */
  __pyx_tuple_ = <span class='py_c_api'>PyTuple_Pack</span>(1, __pyx_kp_s_Can_only_use_Waiter_switch_metho);<span
                class='error_goto'> if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 116, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple_);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple_);
</pre>
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">117</span>:             <span class="n">switch</span> <span class="o">=</span> <span class="n">greenlet</span><span
            class="o">.</span><span class="n">switch</span></pre>
    <pre class='cython code score-2 '>    __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_greenlet), __pyx_n_s_switch);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 117, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">118</span>:             <span class="k">try</span><span class="p">:</span></pre>
...
/* … */
  ...
  __pyx_L3:;
    ...
    <pre class="cython line score-16"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">119</span>:                 <span class="n">switch</span><span class="p">(</span><span class="n">value</span><span
            class="p">)</span></pre>
    <pre class='cython code score-16 '>        <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_v_switch);
        ...
        __pyx_t_1 = (__pyx_t_8) ? __Pyx_PyObject_Call2Args(__pyx_t_7, __pyx_t_8, __pyx_v_value) : <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_7, __pyx_v_value);
        <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_8); __pyx_t_8 = 0;
    ...
    <pre class="cython line score-4"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">120</span>:             <span class="k">except</span><span class="p">:</span> <span class="c"># pylint:disable=bare-except</span></pre>
    <pre class='cython code score-4 '>      /*except:*/ {
        <span class='pyx_c_api'>__Pyx_AddTraceback</span>("gevent.__waiter.Waiter.switch", __pyx_clineno, __pyx_lineno, __pyx_filename);
        if (<span
                class='pyx_c_api'>__Pyx_GetException</span>(&amp;__pyx_t_1, &amp;__pyx_t_7, &amp;__pyx_t_8) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 120, __pyx_L7_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    ...
    <pre class="cython line score-45"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">121</span>:                 <span class="bp">self</span><span class="o">.</span><span
            class="n">hub</span><span class="o">.</span><span class="n">handle_error</span><span class="p">(</span><span
            class="n">switch</span><span class="p">,</span> <span class="o">*</span><span class="n">sys</span><span
            class="o">.</span><span class="n">exc_info</span><span class="p">())</span></pre>
    <pre class='cython code score-45 '>        __pyx_t_9 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self-&gt;hub), __pyx_n_s_handle_error);<span
            class='error_goto'> if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 121, __pyx_L7_except_error)</span>
        ...
        __pyx_t_12 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_6gevent_8__waiter_sys, __pyx_n_s_exc_info);<span
                class='error_goto'> if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 121, __pyx_L7_except_error)</span>
        ...
        __pyx_t_11 = (__pyx_t_13) ? <span
                class='pyx_c_api'>__Pyx_PyObject_CallOneArg</span>(__pyx_t_12, __pyx_t_13) : <span class='pyx_c_api'>__Pyx_PyObject_CallNoArg</span>(__pyx_t_12);
        ...
        <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_12); __pyx_t_12 = 0;
        __pyx_t_12 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_t_9, __pyx_t_11, NULL);<span
                class='error_goto'> if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 121, __pyx_L7_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_12);
    ...
    <pre class="cython line score-34"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">123</span>:     <span class="k">def</span> <span class="nf">switch_args</span><span
...
static PyObject *__pyx_pw_6gevent_8__waiter_6Waiter_13switch_args(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds) &amp;&amp; unlikely(<span class='py_c_api'>PyDict_Size</span>(__pyx_kwds) &gt; 0) &amp;&amp; unlikely(!<span
                class='pyx_c_api'>__Pyx_CheckKeywordStrings</span>(__pyx_kwds, "switch_args", 0))) return NULL;
...
/* … */
  __pyx_tuple__11 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_args);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 123, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__11);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__11);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_13switch_args, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_switch_args, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__12));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_switch_args, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 123, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__12 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARARGS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__11, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_switch_args, 123, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 123, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">124</span>:         <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">switch</span><span class="p">(</span><span class="n">args</span><span
            class="p">)</span></pre>
    <pre class='cython code score-17 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_t_2 = <span
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-42"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">126</span>:     <span class="k">def</span> <span class="nf">throw</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="o">*</span><span
            class="n">throw_args</span><span class="p">):</span></pre>
...
/* … */
  __pyx_tuple__13 = <span class='py_c_api'>PyTuple_Pack</span>(4, __pyx_n_s_self, __pyx_n_s_throw_args, __pyx_n_s_greenlet, __pyx_n_s_throw);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__13)) __PYX_ERR(0, 126, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__13);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__13);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_15throw, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_throw, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__14));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 126, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_throw, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 126, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__14 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARARGS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_throw, 126, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__14)) __PYX_ERR(0, 126, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">127</span>:         <span class="sd">&quot;&quot;&quot;Switch to the greenlet with the exception. If there&#39;s no greenlet, store the exception.&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">128</span>:         <span class="n">greenlet</span> <span class="o">=</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">greenlet</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = ((PyObject *)__pyx_v_self-&gt;greenlet);
  <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_t_1);
  __pyx_v_greenlet = ((PyGreenlet *)__pyx_t_1);
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">129</span>:         <span class="k">if</span> <span class="n">greenlet</span> <span
            class="ow">is</span> <span class="bp">None</span><span class="p">:</span></pre>
    <pre class='cython code score-0 '>  __pyx_t_2 = (((PyObject *)__pyx_v_greenlet) == Py_None);
  __pyx_t_3 = (__pyx_t_2 != 0);
  if (__pyx_t_3) {
/* … */
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">130</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">_exception</span> <span
            class="o">=</span> <span class="n">throw_args</span></pre>
    ...
    <pre class="cython line score-0">&#xA0;<span class="">131</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">132</span>:             <span class="k">if</span> <span class="n">getcurrent</span><span class="p">()</span> <span
            class="ow">is</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span
            class="n">hub</span><span class="p">:</span> <span
            class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-1 '>  /*else*/ {
...
/* … */
    ...
    <pre class="cython line score-5"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">133</span>:                 <span class="k">raise</span> <span
            class="ne">AssertionError</span><span class="p">(</span><span class="s">&quot;Can only use Waiter.switch method from the Hub greenlet&quot;</span><span
            class="p">)</span></pre>
    <pre class='cython code score-5 '>      __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_builtin_AssertionError, __pyx_tuple_, NULL);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 133, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
      <span class='pyx_c_api'>__Pyx_Raise</span>(__pyx_t_1, 0, 0, 0);
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">134</span>:             <span class="n">throw</span> <span class="o">=</span> <span class="n">greenlet</span><span
            class="o">.</span><span class="n">throw</span></pre>
    <pre class='cython code score-2 '>    __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_greenlet), __pyx_n_s_throw);<span
    ...
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">135</span>:             <span class="k">try</span><span class="p">:</span></pre>
...
/* … */
  ...
  __pyx_L3:;
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">136</span>:                 <span class="n">throw</span><span class="p">(</span><span
            class="o">*</span><span class="n">throw_args</span><span class="p">)</span></pre>
    <pre class='cython code score-3 '>        __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_Call</span>(__pyx_v_throw, __pyx_v_throw_args, NULL);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 136, __pyx_L5_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
        <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
</pre>
    <pre class="cython line score-4"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">137</span>:             <span class="k">except</span><span class="p">:</span> <span class="c"># pylint:disable=bare-except</span></pre>
    <pre class='cython code score-4 '>      /*except:*/ {
        <span class='pyx_c_api'>__Pyx_AddTraceback</span>("gevent.__waiter.Waiter.throw", __pyx_clineno, __pyx_lineno, __pyx_filename);
        if (<span
                class='pyx_c_api'>__Pyx_GetException</span>(&amp;__pyx_t_1, &amp;__pyx_t_7, &amp;__pyx_t_8) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 137, __pyx_L7_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_7);
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_8);
</pre>
    <pre class="cython line score-45"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">138</span>:                 <span class="bp">self</span><span class="o">.</span><span
            class="n">hub</span><span class="o">.</span><span class="n">handle_error</span><span class="p">(</span><span
            class="n">throw</span><span class="p">,</span> <span class="o">*</span><span class="n">sys</span><span
            class="o">.</span><span class="n">exc_info</span><span class="p">())</span></pre>
    <pre class='cython code score-45 '>        __pyx_t_9 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self-&gt;hub), __pyx_n_s_handle_error);<span
            class='error_goto'> if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 138, __pyx_L7_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_9);
        ...
        __pyx_t_12 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_6gevent_8__waiter_sys, __pyx_n_s_exc_info);<span
                class='error_goto'> if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 138, __pyx_L7_except_error)</span>
        <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_12);
        __pyx_t_13 = NULL;
        if (CYTHON_UNPACK_METHODS &amp;&amp; likely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_12))) {
          __pyx_t_13 = <span class='py_macro_api'>PyMethod_GET_SELF</span>(__pyx_t_12);
    ...
    <pre class="cython line score-63"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">140</span>:     <span class="k">def</span> <span class="nf">get</span><span class="p">(</span><span
            class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_6Waiter_17get, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_Waiter_get, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__16));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter-&gt;tp_dict, __pyx_n_s_get, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 140, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_Waiter);
  __pyx_codeobj__16 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__15, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_get, 140, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__16)) __PYX_ERR(0, 140, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-0">&#xA0;<span class="">141</span>:         <span class="sd">&quot;&quot;&quot;If a value/an exception is stored, return/raise it. Otherwise until switch() or throw() is called.&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">142</span>:         <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span
            class="ow">not</span> <span class="n">_NONE</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">143</span>:             <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">_exception</span> <span class="ow">is</span> <span
            class="bp">None</span><span class="p">:</span></pre>
...
/* … */
    ...
    <pre class="cython line score-2"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">144</span>:                 <span class="k">return</span> <span class="bp">self</span><span
    ...
    <pre class="cython line score-10"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">145</span>:             <span class="n">getcurrent</span><span class="p">()</span><span
            class="o">.</span><span class="n">throw</span><span class="p">(</span><span class="o">*</span><span
    ...
    <pre class='cython code score-10 '>    __pyx_t_1 = ((PyObject *)__pyx_f_6gevent_8__waiter_getcurrent());<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_t_1, __pyx_n_s_throw);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PySequence_Tuple</span>(__pyx_v_self-&gt;_exception);<span
                class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 145, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
    ...
    <pre class="cython line score-0">&#xA0;<span class="">146</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">147</span>:             <span class="k">if</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">greenlet</span> <span class="ow">is</span> <span
...
/* … */
    ...
    <pre class="cython line score-29"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">148</span>:                 <span class="k">raise</span> <span
            class="n">ConcurrentObjectUseError</span><span class="p">(</span><span class="s">&#39;This Waiter is already used by </span><span
            class="si">%r</span><span class="s">&#39;</span> <span class="o">%</span> <span class="p">(</span><span
            class="bp">self</span><span class="o">.</span><span class="n">greenlet</span><span class="p">,</span> <span
            class="p">))</span></pre>
    <pre class='cython code score-29 '>      __pyx_t_1 = <span class='py_c_api'>PyTuple_New</span>(1);<span
      ...
      __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyString_Format</span>(__pyx_kp_s_This_Waiter_is_already_used_by_r, __pyx_t_1);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 148, __pyx_L1_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">149</span>:             <span class="bp">self</span><span class="o">.</span><span class="n">greenlet</span> <span
            class="o">=</span> <span class="n">getcurrent</span><span class="p">()</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    <pre class='cython code score-1 '>    __pyx_t_3 = ((PyObject *)__pyx_f_6gevent_8__waiter_getcurrent());<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 149, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_t_3);
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_v_self-&gt;greenlet);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(((PyObject *)__pyx_v_self-&gt;greenlet));
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">150</span>:             <span class="k">try</span><span class="p">:</span></pre>
    <pre class='cython code score-0 '>    /*try:*/ {
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">151</span>:                 <span class="k">return</span> <span class="bp">self</span><span
            class="o">.</span><span class="n">hub</span><span class="o">.</span><span class="n">switch</span><span
            class="p">()</span></pre>
    <pre class='cython code score-1 '>      <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
      __pyx_t_3 = ((struct __pyx_vtabstruct_6gevent_21__greenlet_primitives_SwitchOutGreenletWithLoop *)__pyx_v_self-&gt;hub-&gt;__pyx_vtab)-&gt;__pyx_switch(__pyx_v_self-&gt;hub, 0);<span
                class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 151, __pyx_L7_error)</span>
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
      __pyx_r = __pyx_t_3;
      __pyx_t_3 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">152</span>:             <span class="k">finally</span><span
            class="p">:</span></pre>
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">153</span>:                 <span class="bp">self</span><span class="o">.</span><span class="n">greenlet</span> <span
            class="o">=</span> <span class="bp">None</span></pre>
    <pre class='cython code score-18 '>    /*finally:*/ {
      ...
      /*exception exit:*/{
        ...
        if ((PY_MAJOR_VERSION &lt; 3) || unlikely(<span class='pyx_c_api'>__Pyx_GetException</span>(&amp;__pyx_t_10, &amp;__pyx_t_11, &amp;__pyx_t_12) &lt; 0)) <span
                class='pyx_c_api'>__Pyx_ErrFetch</span>(&amp;__pyx_t_10, &amp;__pyx_t_11, &amp;__pyx_t_12);
  ...
  __pyx_L3:;
    ...
    <pre class="cython line score-25"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">155</span>:     <span class="k">def</span> <span class="nf">__call__</span><span class="p">(</span><span
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args &gt; 0)) {
        if (unlikely(<span class='pyx_c_api'>__Pyx_ParseOptionalKeywords</span>(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__call__") &lt; 0)) <span
                class='error_goto'>__PYX_ERR(0, 155, __pyx_L3_error)</span>
      }
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-3"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">156</span>:         <span class="k">if</span> <span class="n">source</span><span class="o">.</span><span
            class="n">exception</span> <span class="ow">is</span> <span class="bp">None</span><span
            class="p">:</span></pre>
    <pre class='cython code score-3 '>  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_source, __pyx_n_s_exception);<span
...
/* … */
    ...
    <pre class="cython line score-20"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">157</span>:             <span class="bp">self</span><span class="o">.</span><span
            class="n">switch</span><span class="p">(</span><span class="n">source</span><span class="o">.</span><span
            class="n">value</span><span class="p">)</span></pre>
    <pre class='cython code score-20 '>    __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_switch);<span
            class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 157, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
    __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_source, __pyx_n_s_value);<span
    ...
    <pre class="cython line score-0">&#xA0;<span class="">158</span>:         <span class="k">else</span><span
            class="p">:</span></pre>
    <pre class="cython line score-20"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">159</span>:             <span class="bp">self</span><span class="o">.</span><span
            class="n">throw</span><span class="p">(</span><span class="n">source</span><span class="o">.</span><span
            class="n">exception</span><span class="p">)</span></pre>
    <pre class='cython code score-20 '>  /*else*/ {
    __pyx_t_4 = <span
                class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_v_self), __pyx_n_s_throw);<span
                class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
    __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(__pyx_v_source, __pyx_n_s_exception);<span
                class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 159, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
    __pyx_t_6 = NULL;
    if (CYTHON_UNPACK_METHODS &amp;&amp; likely(<span class='py_c_api'>PyMethod_Check</span>(__pyx_t_4))) {
      __pyx_t_6 = <span class='py_macro_api'>PyMethod_GET_SELF</span>(__pyx_t_4);
  ...
  __pyx_L3:;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">161</span>:     <span class="c"># can also have a debugging version, that wraps the value in a tuple (self, value) in switch()</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">162</span>:     <span class="c"># and unwraps it in wait() thus checking that switch() was indeed called</span></pre>
    ...
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">166</span>: <span class="k">class</span> <span class="nc">MultipleWaiter</span><span
            class="p">(</span><span class="n">Waiter</span><span class="p">):</span></pre>
...
static struct __pyx_vtabstruct_6gevent_8__waiter_MultipleWaiter *__pyx_vtabptr_6gevent_8__waiter_MultipleWaiter;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">167</span>:     <span
            class="sd">&quot;&quot;&quot;</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">168</span>: <span class="sd">    An internal extension of Waiter that can be used if multiple objects</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">169</span>: <span class="sd">    must be waited on, and there is a chance that in between waits greenlets</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">170</span>: <span class="sd">    might be switched out. All greenlets that switch to this waiter</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">171</span>: <span class="sd">    will have their value returned.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">172</span>: </pre>
    <pre class="cython line score-0">&#xA0;<span class="">173</span>: <span class="sd">    This does not handle exceptions or throw methods.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">174</span>: <span
            class="sd">    &quot;&quot;&quot;</span></pre>
    <pre class="cython line score-18"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">175</span>:     <span class="n">__slots__</span> <span class="o">=</span> <span
            class="p">[</span><span class="s">&#39;_values&#39;</span><span class="p">]</span></pre>
    <pre class='cython code score-18 '>  __pyx_t_2 = <span class='py_c_api'>PyList_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 175, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_MultipleWaiter-&gt;tp_dict, __pyx_n_s_slots, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 175, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
...
/* … */
  ...
  return __pyx_r;
    ...
    <pre class="cython line score-40"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">178</span>:         <span class="n">Waiter</span><span class="o">.</span><span
    ...
    <pre class='cython code score-40 '>  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter), __pyx_n_s_init);<span
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-0">&#xA0;<span class="">179</span>:         <span class="c"># we typically expect a relatively small number of these to be outstanding.</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">180</span>:         <span class="c"># since we pop from the left, a deque might be slightly</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">181</span>:         <span class="c"># more efficient, but since we&#39;re in the hub we avoid imports if</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">182</span>:         <span class="c"># we can help it to better support monkey-patching, and delaying the import</span></pre>
    <pre class="cython line score-0">&#xA0;<span class="">183</span>:         <span class="c"># here can be impractical (see https://github.com/gevent/gevent/issues/652)</span></pre>
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">184</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_values</span> <span class="o">=</span> <span class="nb">list</span><span
            class="p">()</span></pre>
  ...
  __pyx_t_1 = 0;
    ...
    <pre class="cython line score-27"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">186</span>:     <span class="k">def</span> <span class="nf">switch</span><span
            class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">value</span><span
            class="p">):</span></pre>
...
/* … */
  __pyx_tuple__17 = <span class='py_c_api'>PyTuple_Pack</span>(2, __pyx_n_s_self, __pyx_n_s_value);<span
                class='error_goto'> if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 186, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_tuple__17);
  <span class='refnanny'>__Pyx_GIVEREF</span>(__pyx_tuple__17);
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_14MultipleWaiter_3switch, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_MultipleWaiter_switch, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__18));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 186, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_MultipleWaiter-&gt;tp_dict, __pyx_n_s_switch, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 186, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_MultipleWaiter);
  __pyx_codeobj__18 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__17, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_switch, 186, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__18)) __PYX_ERR(0, 186, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-7"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">187</span>:         <span class="bp">self</span><span class="o">.</span><span
            class="n">_values</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span
            class="n">value</span><span class="p">)</span></pre>
  ...
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyList_Append</span>(__pyx_v_self-&gt;_values, __pyx_v_value);<span
                class='error_goto'> if (unlikely(__pyx_t_1 == ((int)-1))) __PYX_ERR(0, 187, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-40"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">188</span>:         <span class="n">Waiter</span><span class="o">.</span><span
            class="n">switch</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span
            class="bp">True</span><span class="p">)</span></pre>
    <pre class='cython code score-40 '>  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyObject_GetAttrStr</span>(((PyObject *)__pyx_ptype_6gevent_8__waiter_Waiter), __pyx_n_s_switch);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 188, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  __pyx_t_4 = NULL;
  __pyx_t_5 = 0;
  ...
  if (<span class='py_c_api'>PyFunction_Check</span>(__pyx_t_3)) {
    ...
    __pyx_t_2 = <span class='pyx_c_api'>__Pyx_PyFunction_FastCall</span>(__pyx_t_3, __pyx_temp+1-__pyx_t_5, 2+__pyx_t_5);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 188, __pyx_L1_error)</span>
    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  } else
  #endif
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-27"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">190</span>:     <span class="k">def</span> <span class="nf">get</span><span class="p">(</span><span
            class="bp">self</span><span class="p">):</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_14MultipleWaiter_5get, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_MultipleWaiter_get, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__20));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 190, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>((PyObject *)__pyx_ptype_6gevent_8__waiter_MultipleWaiter-&gt;tp_dict, __pyx_n_s_get, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 190, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  <span class='py_c_api'>PyType_Modified</span>(__pyx_ptype_6gevent_8__waiter_MultipleWaiter);
  __pyx_codeobj__20 = (PyObject*)<span class='pyx_c_api'>__Pyx_PyCode_New</span>(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_gevent__waiter_py, __pyx_n_s_get, 190, __pyx_empty_bytes);<span
                class='error_goto'> if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 190, __pyx_L1_error)</span>
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">191</span>:         <span class="k">if</span> <span class="ow">not</span> <span
            class="bp">self</span><span class="o">.</span><span class="n">_values</span><span class="p">:</span></pre>
    <pre class='cython code score-1 '>  __pyx_t_1 = (__pyx_v_self-&gt;_values != Py_None)&amp;&amp;(<span
            class='py_macro_api'>PyList_GET_SIZE</span>(__pyx_v_self-&gt;_values) != 0);
  __pyx_t_2 = ((!__pyx_t_1) != 0);
  if (__pyx_t_2) {
/* … */
  }
    ...
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">192</span>:             <span class="n">Waiter</span><span class="o">.</span><span
            class="n">get</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span></pre>
    <pre class='cython code score-1 '>    __pyx_t_3 = __pyx_f_6gevent_8__waiter_6Waiter_get(((struct __pyx_obj_6gevent_8__waiter_Waiter *)__pyx_v_self), 1);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 192, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre>
    <pre class="cython line score-1"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">193</span>:             <span class="n">Waiter</span><span class="o">.</span><span
            class="n">clear</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span></pre>
    <pre class='cython code score-1 '>    __pyx_t_3 = __pyx_f_6gevent_8__waiter_6Waiter_clear(((struct __pyx_obj_6gevent_8__waiter_Waiter *)__pyx_v_self), 1);<span
            class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 193, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre>
    ...
    <pre class="cython line score-8"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            ...
            class="o">.</span><span class="n">_values</span><span class="o">.</span><span class="n">pop</span><span
  ...
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyList_PopIndex</span>(__pyx_v_self-&gt;_values, __pyx_int_0, 0, 1, Py_ssize_t, PyInt_FromSsize_t);<span
  ...
  goto __pyx_L0;
    ...
    <pre class="cython line score-9"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">197</span>: <span class="k">def</span> <span class="nf">_init</span><span
            class="p">():</span></pre>
...
/* … */
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_CyFunction_NewEx</span>(&amp;__pyx_mdef_6gevent_8__waiter_1_init, 0, __pyx_n_s_init_2, NULL, __pyx_n_s_gevent___waiter, __pyx_d, ((PyObject *)__pyx_codeobj__21));<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 197, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_d, __pyx_n_s_init_2, __pyx_t_2) &lt; 0) <span
                class='error_goto'>__PYX_ERR(0, 197, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
</pre>
    <pre class="cython line score-0"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">198</span>:     <span class="n">greenlet_init</span><span class="p">()</span> <span class="c"># pylint:disable=undefined-variable</span></pre>
    ...
    <pre class="cython line score-6"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">200</span>: <span class="n">_init</span><span class="p">()</span></pre>
    <pre class='cython code score-6 '>  <span class='pyx_c_api'>__Pyx_GetModuleGlobalName</span>(__pyx_t_2, __pyx_n_s_init_2);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 200, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
    ...
    <pre class="cython line score-19"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">203</span>: <span class="k">from</span> <span class="nn">gevent._util</span> <span
            class="k">import</span> <span class="n">import_c_accel</span></pre>
    <pre class='cython code score-19 '>  __pyx_t_1 = <span class='py_c_api'>PyList_New</span>(1);<span
            class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 203, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  ...
  __pyx_t_2 = <span class='pyx_c_api'>__Pyx_Import</span>(__pyx_n_s_gevent__util, __pyx_t_1, 0);<span
                class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 203, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  ...
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
    ...
    <pre class="cython line score-17"
         onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span
            class="">204</span>: <span class="n">import_c_accel</span><span class="p">(</span><span
            class="nb">globals</span><span class="p">(),</span> <span class="s">&#39;gevent.__waiter&#39;</span><span
            class="p">)</span></pre>
    <pre class='cython code score-17 '>  <span class='pyx_c_api'>__Pyx_GetModuleGlobalName</span>(__pyx_t_2, __pyx_n_s_import_c_accel);<span
            class='error_goto'> if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 204, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
