...
def test_contribute_prv(token1, token2):
    ...
    all_share_amount = pde_state_b4.get_pde_shares_amount_list(None, token1, token2)
    owner_share_amount = pde_state_b4.get_pde_shares_amount_list(token_owner, token2, token1)[0]
    ...
    all_share_amount_after = pde_state_af.get_pde_shares_amount_list(None, token1, token2)
