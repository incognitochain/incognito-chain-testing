...
from IncognitoChain.Helpers.Logging import INFO, ERROR, STEP
...
from IncognitoChain.Objects.IncognitoTestCase import BEACON_ACCOUNTS, COMMITTEE_ACCOUNTS, STAKERS_ACCOUNT, ACCOUNTS
from IncognitoChain.Objects.IncognitoTestCase import SUT

group_acc = BEACON_ACCOUNTS + COMMITTEE_ACCOUNTS + STAKERS_ACCOUNT + ACCOUNTS
list_shard1 = []
list_shard0 = []
for acc in ACCOUNTS:
    if acc.shard % 2 == 0:
