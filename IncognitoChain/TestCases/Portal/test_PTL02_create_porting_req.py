...
def test_create_porting_req_1_1(porting_amount, porting_fee, num_of_custodian, desired_status):
    ...
    estimated_total_lock_collateral = PortalHelper.cal_lock_collateral(porting_amount, pbnb_rate, prv_rate)
    ...
    if desired_status == 'invalid':
        ...
        for custodian in porting_req_info.get_custodians():
            ...
            bnb_rate_be4 = PSI_before_test.get_portal_rate(PBNB_ID)
            ...
            bnb_rate_after = PSI_porting_completed.get_portal_rate(PBNB_ID)
            ...
            if desired_status == 'valid':
                ...
                if PSI_after_req.will_custodian_be_liquidated_with_new_rate(custodian, PBNB_ID, pbnb_rate,
                    ...
                    estimated_liquidated_amount, return_collateral = PSI_porting_completed. \
                        estimate_liquidation_of_custodian(custodian, PBNB_ID, pbnb_rate, new_prv_rate,
